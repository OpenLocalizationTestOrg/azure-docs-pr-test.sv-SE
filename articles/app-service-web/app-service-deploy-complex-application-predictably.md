...
Nu ska vi titta på hur GitHub-lagringsplatsen har ställts in. Du kommer att använda JSON-redigerare i Azure .NET SDK, så om du inte redan har installerat [Azure .NET SDK 2.6](/downloads/), göra det nu.
