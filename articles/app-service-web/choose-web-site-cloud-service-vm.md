...
* Snabbt skapa en [mobilappen](../app-service-mobile/app-service-mobile-value-prop.md) eller [API-app](../app-service-api/app-service-api-apps-why-best-platform.md) som värd för HTTP-webbtjänsten i en Azure globalt har distribuerats datacenter.
