...
Den här kursen visar hur du distribuerar appen till [Azure App Service] från en Git-lagringsplats på den lokala datorn. Apptjänst har stöd för den här metoden med den **lokala Git** distributionsalternativ i den [Azure Portal].  
Många av Git-kommandon som beskrivs i den här artikeln ska utföras automatiskt när du skapar en Apptjänst-app med den [Azure-kommandoradsgränssnittet] enligt [här](app-service-web-get-started.md).
