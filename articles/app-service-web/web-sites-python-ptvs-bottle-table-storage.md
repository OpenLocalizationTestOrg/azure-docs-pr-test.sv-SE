...
---
# <a name="bottle-and-azure-table-storage-on-azure-with-python-tools-22-for-visual-studio"></a>Bottle och Azure Table Storage på Azure med Python Tools 2.2 för Visual Studio
I den här kursen använder vi [Python Tools för Visual Studio] toocreate ett enkelt avfrågar webbapp med någon av exempelmallarna i hello PTVS. Den här kursen finns också tillgänglig som en [video](https://www.youtube.com/watch?v=GJXDGaEPy94).
...
2. Hej projektmallar från hello [Python Tools 2.2 för Visual Studio Samples VSI] är tillgängliga under **Python**, **exempel**. Välj **avsökningar Bottle webbprojekt** och klicka på OK toocreate hello projektet.
...
2. Klicka på hello **ny** ikonen hello längst upp till vänster i hello Portal och klicka sedan på **Data + lagring** > **Lagringskonto**.  Klicka på hello **skapa** knappen ge hello storage-konto ett unikt namn och sedan skapa en ny [resursgruppen](../azure-resource-manager/resource-group-overview.md) för den.
...
3. Klicka på hello **åtkomstnycklar** ingår i hello lagringskontots bladet. Anteckna hello kontonamnet och key1.
...
I det här avsnittet konfigurerar vi våra program toouse hello lagringskonto vi just skapade. Sedan ska vi kör hello program lokalt.
...
1. I [Azure Portal], öppna hello webbapps blad genom att klicka på **Bläddra** > **Apptjänster** > din webbprogrammets namn.
...
Följ dessa länkar toolearn mer om Python Tools för Visual Studio, Bottle och Azure Table Storage.
