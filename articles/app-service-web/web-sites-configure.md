...
**Web Sockets**. Ange **ON** att WebSocket-protokollet, till exempel om ditt webbprogram använder [ASP.NET SignalR] eller [socket.io].
...
* Ställ in kontinuerlig distribution. Se [med Git för att distribuera Webbappar i Azure App Service](web-sites-deploy.md).
