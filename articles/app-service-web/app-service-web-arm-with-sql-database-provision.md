...
### <a name="alert-rules-for-status-codes-403-and-500s-high-cpu-and-http-queue-length"></a>Varningsregler för 403-statuskoder och 500's hög processor- och HTTP-Kölängd
    {
      "apiVersion": "2014-04-01",
