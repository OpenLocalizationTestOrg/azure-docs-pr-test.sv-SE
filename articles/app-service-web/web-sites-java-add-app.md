...
När du har initierat Java-webbappen i [Azure App Service] [ Azure App Service] som beskrivs i [skapar en Java-webbapp i Azure App Service](web-sites-java-get-started.md), kan du överföra ditt program genom att placera din WAR i den **webbappar** mapp.
...
[distribuera din app till Azure App Service]: ./web-sites-deploy.md
