...
Du kan strömma en anpassningsbar bithastighet MP4-uppsättningen genom att skapa en positionerare för strömning och skapa en strömnings-URL. Hej [koda en tillgång](media-services-rest-encode-asset.md) avsnittet visas hur tooencode i en MP4 med anpassningsbar bithastighet. Om ditt innehåll är krypterad, konfigurera principen för tillgångsleverans (enligt beskrivningen i [detta](media-services-rest-configure-asset-delivery-policy.md) avsnittet) innan du skapar en positionerare. 
...
Det här avsnittet visar hur toocreate en strömmande positionerare i ordning toopublish din tillgång och skapa en Smooth, MPEG DASH och HLS-strömnings-URL: er. Den visar även varm toobuild URL: er för progressiv nedladdning.

Hej [följande](#types) avsnittet visar hello enum-typer vars värden används i hello REST-anrop.   
...
toocreate hello OnDemand-strömning positionerare och hämta URL: er som du behöver toodo hello följande:
...
### <a name="create-an-ondemand-streaming-locator"></a>Skapa en OnDemand-strömning lokaliserare
Skapa hello positionerare för hello angivna tillgången och tillgångsinformation principen.
...
Använd hello **sökväg** värdet som returneras efter hello generering av hello lokaliserare toobuild hello Smooth, HLS och MPEG DASH URL: er. 
...
Använd hello **sökväg** värdet som returneras efter hello generering av hello lokaliserare toobuild hello progressiv nedladdning URL.   
