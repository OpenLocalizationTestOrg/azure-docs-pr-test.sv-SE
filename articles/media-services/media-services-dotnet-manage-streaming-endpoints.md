...
>[!NOTE]
>Se till att tooreview hello [översikt](media-services-streaming-endpoints-overview.md) avsnittet. Granska även [StreamingEndpoint](https://docs.microsoft.com/rest/api/media/operations/streamingendpoint).

hello kod i det här avsnittet visar hur toodo hello följande aktiviteter med hjälp av hello Azure Media Services .NET SDK:

- Granska hello standard strömmande slutpunkten.
- Skapa/lägga till nya strömmande slutpunkt.

    Du kanske vill toohave flera strömningsslutpunkter om du planerar toohave olika CDN-nät eller en CDN och direktåtkomst.
...
- Uppdatera hello strömmande slutpunkten.
    ...
    Se till att toocall hello Update() funktion.

- Ta bort hello strömmande slutpunkten.
...
Ersätt hello koden i hello Program.cs med följande kod hello:
