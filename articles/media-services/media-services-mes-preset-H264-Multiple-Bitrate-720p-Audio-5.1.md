---
title: aaaH264 flera bithastighet 720p ljud 5.1 | Microsoft Docs
description: "hello avsnittet ger andverview av hello ** H264 Multibithastighet 720p ljud 5.1* * aktiviteten förinställda."
author: Juliako
manager: cfowler
editor: 
...
---
# <a name="h264-multiple-bitrate-720p-audio-51"></a>H264 Flera bithastighet 720p ljud 5.1
`Media Encoder Standard`definierar en uppsättning kodning förinställningar som du kan använda när du skapar kodning jobb. Du kan använda en `preset name` toospecify i vilket format du vill att tooencode media-fil. Du kan också skapa egna JSON eller XML-baserade förinställningar (med hjälp av UTF-8- eller UTF-16-kodning. Du skulle sedan överföra hello anpassade förinställda toohello kodare. Hello lista över alla hello förinställningen namn som stöds av det här `Media Encoder Standard` kodare, se [aktivitet förinställningar för Media Encoder Standard](media-services-mes-presets-overview.md).  
 ...
 Det här avsnittet visar hello `H264 Multiple Bitrate 720p Audio 5.1` förinställda XML och JSON-format.  
  
 Den här förinställningen producerar en uppsättning 6 GOP-justerad MP4-filer från 3400 kbit/s too400 kbit/s och AAC 5.1 ljud. Detaljerad information om profilen bithastighet, provtagning hastighet, etc. Om detta förinställda ska undersöka hello XML- eller JSON som anges nedan. Förklaringar av vad varje element innebär och hello giltiga värden för varje element finns hello [Media Encoder Standard schemat](media-services-mes-schema.md).  
