...
Det här avsnittet visar hur toocreate en kodning uppgift som genererar fragmenterad MP4 (fMP4) segment i stället för ISO MP4-filer. toogenerate fMP4 segment använder hello **Media Encoder Standard** eller **Media Encoder Premium arbetsflöde** kodare toocreate kodning uppgift och även ange  **AssetFormatOption.AdaptiveStreaming** alternativ, som visas i det här kodstycket:  
