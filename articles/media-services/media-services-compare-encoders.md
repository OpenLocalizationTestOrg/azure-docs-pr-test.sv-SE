...
Det här avsnittet jämför hello kodning funktionerna i **Media Encoder Standard** och **Media Encoder Premium arbetsflöde**.

## <a name="video-and-audio-processing-capabilities"></a>Video och ljud bearbetningsfunktioner

hello följande tabell jämförs hello funktionalitet mellan Media Encoder Standard (MES) och Media Encoder Premium arbetsflöde (MEPW). 

|Funktion|Media Encoder Standard|Arbetsflöde för Media Encoder Premium|
|---|---|---|
|Tillämpa villkorlig logik vid kodning<br/>(till exempel om hello-indata är HD, sedan koda 5.1 ljud)|Nej|Ja|
...
| --- | --- | --- |
| **Media Encoder Standard** |KODAREN |Kodning uppgifter debiteras baserat på hello total varaktighet i minuter, av alla hello mediefiler som, vid hello angivna [här][1], under hello KODARE kolumn. |
| **Arbetsflöde för Media Encoder Premium** |PREMIUM-KODARE |Kodning uppgifter debiteras baserat på hello total varaktighet i minuter, av alla hello mediefiler som, vid hello angivna [här][1], under hello PREMIUM-KODARE kolumn. |
...
| --- | --- | --- |
| AVC 8-/ 10-bitars, in too4:2:2, inklusive AVCIntra |8-bitars 4:2:0 och 4:2:2 |Ja |
| Avid DNxHD (i MXF) |Ja |Ja |
| DVCPro/DVCProHD (i MXF) |Ja |Ja |
| JPEG2000 |Ja |Ja |
| MPEG-2 (too422 profil och högnivå, inklusive varianter, till exempel XDCAM, XDCAM HD, XDCAM IMX, CableLabs® och D10) |Too422 profil |Ja |
| MPEG-1 |Ja |Ja |
...
| AAC (AAC LC, HE AAC och AAC-HEv2 in too5.1) |Ja |Ja |
| MPEG nivå 2 |Ja |Ja |
...
| --- | --- | --- |
| AVC (H.264; 8-bitars upp tooHigh profil, nivå 5.2; 4K extra HD; AVC Intra) |Endast 8-bitars 4:2:0 |Ja |
| Avid DNxHD (i MXF) |Nej |Ja |
| MPEG-2 (too422 profil och högnivå, inklusive varianter, till exempel XDCAM, XDCAM HD, XDCAM IMX, CableLabs® och D10) |Nej |Ja |
| MPEG-1 |Nej |Ja |
...
| AES (SMPTE 331 M och 302 M, AES3 2003) |Nej |Ja |
| Dolby® Digital (AC3) |Nej |Ja |
| Dolby® Digital Plus (E-AC3) in too7.1 |Nej |Ja |
| AAC (AAC LC, HE AAC och AAC-HEv2 in too5.1) |Ja |Ja |
| MPEG nivå 2 |Nej |Ja |
