...
Det här avsnittet visar hur tooperform avancerade encoding med Media Encoder Standard (MES) med hjälp av en anpassad förinställning. hello avsnittet använder .NET toocreate en kodning uppgift och ett jobb som utför den här uppgiften.  

I det här avsnittet visas hur toocustomize en förinställning genom att göra hello [H264 Multibithastighet 720p](media-services-mes-preset-H264-Multiple-Bitrate-720p.md) hello förinställda och minska antalet lager. Hej [Anpassa Media Encoder Standard förinställningar](media-services-advanced-encoding-with-mes.md) avsnittet visar anpassade förinställningar som kan använda tooperform avancerade kodning uppgifter.

## <a id="customizing_presets"></a>Anpassa en MES förinställning

### <a name="original-preset"></a>Ursprungliga förinställda

Spara hello JSON som definierats i hello [H264 Multibithastighet 720p](media-services-mes-preset-H264-Multiple-Bitrate-720p.md) -avsnittet i en fil med JSON. Till exempel **CustomPreset_JSON.json**.

### <a name="customized-preset"></a>Anpassade förinställda

Öppna hello **CustomPreset_JSON.json** filen och ta bort först tre lager från **H264Layers** så filen ser ut så här.
...
- Läsa in hello anpassade JSON förinställningen som du skapade i föregående avsnitt i hello. 
  
        // Load hello JSON from hello local file.
        string configuration = File.ReadAllText(fileName);  

- Lägg till ett kodningsjobb i aktiviteten toohello. 
