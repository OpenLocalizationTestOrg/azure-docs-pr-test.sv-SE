---
title: "aaaH264 Multibithastighet 16 x 9 för iOS | Microsoft Docs"
description: "hello avsnittet ger en översikt över hello ** H264 Multibithastighet 16 x 9 för iOS ** uppgiften förinställda."
author: Juliako
manager: cfowler
editor: 
...
---
# <a name="h264-multiple-bitrate-16x9-for-ios"></a>H264 Multibithastighet 16 x 9 för iOS
`Media Encoder Standard`definierar en uppsättning kodning förinställningar som du kan använda när du skapar kodning jobb. Du kan använda en `preset name` toospecify i vilket format du vill att tooencode media-fil. Du kan också skapa egna JSON eller XML-baserade förinställningar (med hjälp av UTF-8- eller UTF-16-kodning. Du skulle sedan överföra hello anpassade förinställda toohello kodare. Hello lista över alla hello förinställningen namn som stöds av det här `Media Encoder Standard` kodare, se [aktivitet förinställningar för Media Encoder Standard](media-services-mes-presets-overview.md).  
 ...
 Det här avsnittet visar hello `H264 Multiple Bitrate 16x9 for iOS` förinställda XML och JSON-format.  
  
 Den här förinställningen producerar en uppsättning 8 GOP-justerad MP4-filer från 8500 kbit/s too200 kbit/s och AAC stereoljud. Detaljerad information om profilen bithastighet, provtagning hastighet, etc. Om detta förinställda ska undersöka hello XML- eller JSON som anges nedan. Förklaringar av vad varje element i dessa förinställda innebär och hello giltiga värden för varje element finns hello [Media Encoder Standard schemat](media-services-mes-schema.md) avsnittet.  
