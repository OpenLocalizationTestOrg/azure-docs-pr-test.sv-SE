...
Det här avsnittet beskriver allmänna steg som du kan utföra när du konfigurerar hello Azure Media Services (AMS) telemetri med hjälp av REST API. 
...
hello stegen som beskrivs i det här avsnittet är:

- Hämta hello storage-konto som är associerad med ett Media Services-konto
- Hämtning av Aviseringsslutpunkter för hello
- Skapa en Aviseringsslutpunkten för övervakning. 

    toocreate Aviseringsslutpunkten, ange hello EndPointType tooAzureTable (2) och endPontAddress set toohello lagringstabellen (till exempel https://telemetryvalidationstore.table.core.windows.net/).
  
- Hämta hello övervakningskonfigurationer
...
## <a name="get-hello-storage-account-associated-with-a-media-services-account"></a>Hämta hello storage-konto som är associerad med ett Media Services-konto
...
## <a name="get-hello-notification-endpoints"></a>Hämta hello Aviseringsslutpunkter
...
>[!NOTE]
>Glöm inte toochange hello ”https://telemetryvalidationstore.table.core.windows.net” värde tooyour storage-konto.
...
## <a name="get-hello-monitoring-configurations"></a>Hämta hello övervakningskonfigurationer
