...
Det här dokumentet innehåller en lista över hello vanligaste importera och exportera filformat som du kan använda med Media Encoder Standard.
...
> [!NOTE]
> Är en lista med filnamnstillägg för hello ofta påträffade ovan. Media Encoder Standard stöder många andra (till exempel: .m2ts, .mpeg2video, .qt). Lämna feedback om du försöker tooencode en fil och du får ett felmeddelande om hello-format som inte stöds, [här](https://feedback.azure.com/forums/169396-media-services/category/144411-encoding-and-processing/).
> 
> 

### <a name="audio-formats-in-input-containers"></a>Ljud-formaten i inkommande behållare
Media Encoder Standard stöder medför hello följande ljud-formaten i inkommande behållare:

* MXF, GXF och QuickTime filer som har ljud spårar med överlagrad stereo eller 5.1-exempel

eller

* MXF, GXF och QuickTime filer där hello ljud utförs som separata PCM spår men hello kanalmappning (toostereo eller 5.1) härledas från hello filens metadata

Observera att stödet för explicit/användardefinierat kanalmappning ska anges i hello nära framtiden.

## <a name="input-video-codecs"></a>Inkommande Video-codec
| Inkommande Video-codec | Stöds |
| --- | --- | --- | --- |
| AVC 8-/ 10-bitars, in too4:2:2, inklusive AVCIntra |8-bitars 4:2:0 och 4:2:2 |
| Avid DNxHD (i MXF) |Ja |
| DVCPro/DVCProHD (i MXF) |Ja |
| Digital video (DV) (i AVI-filer) |Ja |
| JPEG 2000 |Ja |
| MPEG-2 (too422 profil och högnivå, inklusive varianter, till exempel XDCAM, XDCAM HD, XDCAM IMX, CableLabs® och D10) |Too422 profil |
| MPEG-1 |Ja |
| WMV9-VC-1 |Ja |
| Canopus HQ/HQX |Nej |
| MPEG-4 del 2 |Ja |
...
| --- | --- | --- | --- |
| AAC (AAC LC, HE AAC och AAC-HEv2 in too5.1) |Ja |
| MPEG nivå 2 |Ja |
...
hello i den följande tabellen listas hello codec och filformat som stöds för export.
