...
## [Använd AAD auth tooaccess API](media-services-use-aad-auth-to-access-ams-api.md)
### [Använda portalen toomanage AAD-autentisering](media-services-portal-get-started-with-aad.md)
...
### [Använd CLI toocreate och konfigurera AAD-app](media-services-cli-create-and-configure-aad-app.md)
### [Använd PowerShell toocreate och konfigurera AAD-app](media-services-powershell-create-and-configure-aad-app.md)
...
#### [Använd MES tooauto-Generera en bithastighet stege](media-services-autogen-bitrate-ladder-with-mes.md)
...
##### [Hur toogenerate miniatyrer med Media Encoder Standard med .NET](media-services-dotnet-generate-thumbnail-with-mes.md)
...
### [Konfigurera innehållsskydd i hello-portalen](media-services-portal-protect-content.md)
### [Konfigurera AES-128-klartextnyckel för din dataström](media-services-protect-with-aes128.md)
### [Använda REST tooencrypt ditt innehåll med lagringskryptering](media-services-rest-storage-encryption.md)
...
### [Med hjälp av partners toodeliver Widevine licenser tooMedia tjänster](media-services-licenses-partner-integration.md)
#### [Använda Axinom Services toodeliver Widevine-licenser tooMedia](media-services-axinom-integration.md)
#### [Använda castLabs Services toodeliver Widevine-licenser tooMedia](media-services-castlabs-integration.md)
...
### [Analysera media med hjälp av hello portal](media-services-portal-analyze.md)
...
### [Infoga annonser på hello på klientsidan](media-services-inserting-ads-on-client-side.md)
