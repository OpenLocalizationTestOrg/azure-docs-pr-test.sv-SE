...
Det här avsnittet visar hur toouse REST API: er toocreate, uppdatera och ta bort filter. 
...
toocreate ett globalt Filter med hello efter HTTP-begäranden:  
...
toocreate lokala AssetFilter, Använd hello efter HTTP-begäranden:  
...
### <a name="get-all-global-filters-in-hello-ams-account"></a>Hämta alla globala **Filter**s i hello AMS-konto
toolist filter, Använd hello efter HTTP-begäranden: 
...
Använd KORRIGERA PUT- eller MERGE tooupdate ett filter med nya värden.  Mer information om dessa åtgärder finns [korrigering, PUT, MERGE](http://msdn.microsoft.com/library/dd541276.aspx).
...
tooupdate ett globalt filter med hello efter HTTP-begäranden: 
...
tooupdate lokala filter, Använd hello efter HTTP-begäranden: 
...
toodelete ett globalt Filter med hello efter HTTP-begäranden:
...
toodelete lokala AssetFilter, Använd hello efter HTTP-begäranden:
