...
> [!NOTE]
> Du kan endast använda taggar för resurser som stöder Azure Resource Manager-åtgärder. Om du har skapat en virtuell dator, virtuella nätverk eller lagringskonto via den klassiska distributionsmodellen (exempelvis via den klassiska Azure-portalen), du kan inte använda en tagg till resursen. Distribuera om dessa resurser via Resource Manager för att stödja Taggning. Alla andra resurser stöd för märkning.
> 
> 

## <a name="policies-for-tag-consistency"></a>Principer för taggen konsekvenskontroll

Du kan använda principer för företagsresurser för att skapa standardregler för din organisation. Du kan skapa principer som kontrollera resurser som är märkta med lämpliga värden. Mer information finns i [gäller resursprinciper för taggar](resource-manager-policy-tags.md).
