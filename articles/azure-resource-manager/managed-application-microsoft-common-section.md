...
Åtkomst till utdatavärden av element i `elements`, använda den [basics()](managed-application-createuidefinition-functions.md#basics) eller [steps()](managed-application-createuidefinition-functions.md#steps) funktioner och punktnotation:
