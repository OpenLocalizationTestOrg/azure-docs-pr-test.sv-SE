...
Den här Microsoft-FAQ är en lista över vanliga frågor om logganalys i Microsoft Operations Management Suite (OMS). Om du har några ytterligare frågor om logganalys går du till den [diskussionsforum](https://social.msdn.microsoft.com/Forums/azure/home?forum=opinsights) och dina frågor. När en fråga är vanliga vi lägga till den i den här artikeln så att den finns snabbt och enkelt.
...
S: Nej. Logganalys bearbetar och lagrar stora mängder data. Som en molntjänst kan logganalys skala upp om det behövs och undvika prestandainverkan i din miljö.

Ytterligare fördelar:
- Microsoft körs logganalys-infrastruktur, spara kostnader
...
Under den **Azure logganalys (OMS)** fliken, leta efter en grön bock. En grön bockmarkering som bekräftar att agenten kan kommunicera med tjänsten OMS.

En gul varningsikon innebär att agenten har problem med kommunikation med OMS. En vanlig orsak är Microsoft Monitoring Agent-tjänsten har stoppats. Använda tjänsthanteraren för att starta om tjänsten.
...
S: i System Center Operations Manager, ta bort datorn från listan Advisor-hanterad dator. Operations Manager uppdaterar konfigurationen av agenten inte längre rapporten till logganalys. Agenter som är direkt anslutna till logganalys, kan du stoppa dem från att kommunicera via: Kontrollpanelen, säkerhet och inställningar, **Microsoft Monitoring Agent**.
