...
Lösningen Azure Web Apps Analytics (förhandsversion) ger insikter om din [Azure Web Apps](../app-service-web/app-service-web-overview.md) genom att samla in olika mått för alla webbprogram i Azure-resurser. Med lösningen kan du analysera och söka efter måttdata för web app resurs.
