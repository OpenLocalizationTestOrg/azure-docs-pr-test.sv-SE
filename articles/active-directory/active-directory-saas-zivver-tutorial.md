...
I kursen får du lära dig hur toointegrate ZIVVER med Azure Active Directory (AD Azure).

Integrera ZIVVER med Azure AD ger dig hello följande fördelar:

- Du kan styra i Azure AD som har åtkomst till tooZIVVER.
- Du kan låta dina användare tooautomatically get inloggade tooZIVVER (Single Sign-On) med sina Azure AD-konton.
...
tooconfigure Azure AD-integrering med ZIVVER, behöver du hello följande objekt:
...
1. Att lägga till ZIVVER från hello-galleriet
2. Konfigurera och testa Azure AD enkel inloggning

## <a name="adding-zivver-from-hello-gallery"></a>Att lägga till ZIVVER från hello-galleriet
tooconfigure hello integrering av ZIVVER i Azure AD, behöver du tooadd ZIVVER hello galleriet tooyour listan över hanterade SaaS-appar.

**tooadd ZIVVER från galleriet hello utför hello följande steg:**
...
4. Skriv i sökrutan hello **ZIVVER**väljer **ZIVVER** resultatet-panelen klickar **Lägg till** knappen tooadd hello program.
...
För enkel inloggning toowork måste Azure AD tooknow vilka hello motsvarighet användaren i ZIVVER är tooa i Azure AD. Med andra ord måste en länk mellan en Azure AD-användare och hello relaterade användare i ZIVVER toobe upprättas.

I ZIVVER, tilldela hello värdet för hello **användarnamn** i Azure AD som hello värde för hello **användarnamn** tooestablish hello länken relationen.

tooconfigure och testa Azure AD enkel inloggning med ZIVVER, behöver du toocomplete hello följande byggblock:
...
3. **[Skapa en testanvändare ZIVVER](#create-a-zivver-test-user)**  -toohave en motsvarighet för Britta Simon i ZIVVER som är länkade toohello Azure AD-representation av användaren.
...
I det här avsnittet Aktivera Azure AD enkel inloggning i hello Azure-portalen och konfigurera enkel inloggning i ditt ZIVVER program.

**Utför följande steg hello tooconfigure Azure AD enkel inloggning med ZIVVER:**

1. I hello Azure-portalen på hello **ZIVVER** integreringssidan för programmet, klickar du på **enkel inloggning**.
...
3. På hello **ZIVVER domän och URL: er** avsnittet, utföra hello följande steg:
    ...
    I hello **identifierare** textruta typen hello URL:`https://app.zivver.com/SAML/Zivver`
...
6. tooconfigure enkel inloggning på **ZIVVER** sida, behöver du toosend hello hämtas **XML-Metadata för** för[ZIVVER supportteam](https://support.zivver.com). De kan ange den här inställningen toohave hello SAML SSO anslutningen korrekt på båda sidor.
...
I det här avsnittet skapar du en användare som kallas Britta Simon i ZIVVER. Arbeta med [ZIVVER supportteam](https://support.zivver.com) tooadd hello användare i hello ZIVVER plattform.

### <a name="assign-hello-azure-ad-test-user"></a>Tilldela användare hello Azure AD

I det här avsnittet kan aktivera du Britta Simon toouse Azure enkel inloggning genom att bevilja åtkomst tooZIVVER.

![Tilldela hello användarroll][200] 

**tooassign Britta Simon tooZIVVER utför hello följande steg:**

1. I hello Azure-portalen, öppna hello program visa och navigera toohello directory vy och gå för**företagsprogram** Klicka **alla program**.

    ![Tilldela användare][201] 

2. Välj i listan med program hello **ZIVVER**.
...
Du bör få automatiskt inloggade tooyour ZIVVER programmet när du klickar på hello ZIVVER panelen i hello åtkomstpanelen.
