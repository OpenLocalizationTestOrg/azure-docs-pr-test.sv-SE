...
I kursen får du lära dig hur toointegrate Kintone med Azure Active Directory (AD Azure).

Integrera Kintone med Azure AD ger dig hello följande fördelar:

- Du kan styra i Azure AD som har åtkomst till tooKintone
- Du kan aktivera din användare tooautomatically get inloggade tooKintone (Single Sign-On) med sina Azure AD-konton
...
tooconfigure Azure AD-integrering med Kintone, behöver du hello följande objekt:
...
1. Att lägga till Kintone från hello-galleriet
2. Konfigurera och testa Azure AD enkel inloggning

## <a name="adding-kintone-from-hello-gallery"></a>Att lägga till Kintone från hello-galleriet
tooconfigure hello integrering av Kintone i Azure AD, behöver du tooadd Kintone hello galleriet tooyour listan över hanterade SaaS-appar.

**tooadd Kintone från galleriet hello utför hello följande steg:**
...
4. Skriv i sökrutan hello **Kintone**.

    ![Skapa en testanvändare i Azure AD](./media/active-directory-saas-kintone-tutorial/tutorial_kintone_search.png)

5. Markera hello resultat på panelen **Kintone**, och klicka sedan på **Lägg till** knappen tooadd hello program.
...
För enkel inloggning toowork måste Azure AD tooknow vilka hello motsvarighet användaren i Kintone är tooa i Azure AD. Med andra ord måste en länk mellan en Azure AD-användare och hello relaterade användare i Kintone toobe upprättas.

I Kintone, tilldela hello värdet för hello **användarnamn** i Azure AD som hello värde för hello **användarnamn** tooestablish hello länken relationen.

tooconfigure och testa Azure AD enkel inloggning med Kintone, behöver du toocomplete hello följande byggblock:

1. **[Konfigurera Azure AD enkel inloggning](#configuring-azure-ad-single-sign-on)**  -tooenable användare-toouse den här funktionen.
2. **[Skapa en Azure AD-testanvändare](#creating-an-azure-ad-test-user)**  -tootest Azure AD enkel inloggning med Britta Simon.
3. **[Skapa en testanvändare Kintone](#creating-a-kintone-test-user)**  -toohave en motsvarighet för Britta Simon i Kintone som är länkade toohello Azure AD-representation av användaren.
4. **[Tilldela hello Azure AD-testanvändare](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD enkel inloggning.
5. **[Testa enkel inloggning](#testing-single-sign-on)**  -tooverify hello om konfigurationen fungerar.

### <a name="configuring-azure-ad-single-sign-on"></a>Konfigurera Azure AD enkel inloggning

I det här avsnittet Aktivera Azure AD enkel inloggning i hello Azure-portalen och konfigurera enkel inloggning i ditt Kintone program.

**Utför följande steg hello tooconfigure Azure AD enkel inloggning med Kintone:**

1. I hello Azure-portalen på hello **Kintone** integreringssidan för programmet, klickar du på **enkel inloggning**.
...
3. På hello **Kintone domän och URL: er** avsnittet, utföra hello följande steg:

    ![Konfigurera enkel inloggning](./media/active-directory-saas-kintone-tutorial/tutorial_kintone_url.png)

    a. I hello **inloggnings-URL** textruta, ange ett URL-Adressen med hello följer mönstret:`https://<companyname>.kintone.com`
    ...
    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med hello faktiska inloggnings-URL och identifierare. Kontakta [Kintone klienten supportteamet](https://www.kintone.com/contact/) tooget dessa värden. 
...
6. På hello **Kintone Configuration** klickar du på **konfigurera Kintone** tooopen **konfigurera inloggning** fönster. Kopiera hello **Sign-Out URL och SAML enkel inloggning Tjänstwebbadress** från hello **Snabbreferens avsnitt.**
...
12. I hello avsnittet SAML-autentisering, utföra hello följande steg:
    ...
    b. I hello **logga ut URL** textruta klistra in hello värdet för **Sign-Out URL** som du har kopierat från Azure-portalen.
    
    c. Klicka på **Bläddra** tooupload hämtade certifikatet.
...
tooenable Azure AD-användare toolog i tooKintone, måste de etableras i Kintone.  
Hello gäller Kintone är etablering en manuell aktivitet.
...
1. Logga in tooyour **Kintone** företagets webbplats som administratör.
...
6. I hello **ny användare** avsnittet, utföra hello följande steg:
   
    ![Nya användare](./media/active-directory-saas-kintone-tutorial/ic785890.png "nya användare")
   
    a. Ange en **visningsnamn**, **inloggningsnamnet**, **nytt lösenord**, **Bekräfta lösenord**, **e-postadress**, och annan information på en giltig AAD-konto som du vill tooprovision till hello relaterade textrutor.
 
    b. Klicka på **Spara**.

> [!NOTE]
> Du kan använda något annat Kintone användarens konto skapas verktyg eller API: er som tillhandahålls av Kintone tooprovision AAD-användarkonton.

### <a name="assigning-hello-azure-ad-test-user"></a>Tilldela användare hello Azure AD

I det här avsnittet kan aktivera du Britta Simon toouse Azure enkel inloggning genom att bevilja åtkomst tooKintone.

![Tilldela användare][200] 

**tooassign Britta Simon tooKintone utför hello följande steg:**

1. I hello Azure-portalen, öppna hello program visa och navigera toohello directory vy och gå för**företagsprogram** Klicka **alla program**.

    ![Tilldela användare][201] 

2. Välj i listan med program hello **Kintone**.
...
Du bör få automatiskt inloggade tooyour Kintone programmet när du klickar på hello Kintone panelen i hello åtkomstpanelen.
