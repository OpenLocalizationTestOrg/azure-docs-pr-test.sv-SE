...
## [Lägg till användare tooAzure AD](add-users-azure-active-directory.md)
## [Tilldela licenser toousers](license-users-groups.md)
...
#### [Tilldela licenser tooa grupp](active-directory-licensing-group-assignment-azure-portal.md)
#### [Identifiera och åtgärda licensproblem i en grupp](active-directory-licensing-group-problem-resolution-azure-portal.md)
#### [Migrera enskilda licensierade användare toogroup-baserade licensiering](active-directory-licensing-group-migration-azure-portal.md)
...
### [Lägg till grupp åtkomst tooSaaS appar](active-directory-accessmanagement-group-saasapps.md)
...
#### [Använd hello Azure Active Directory Power BI-Innehållspaketen](active-directory-reporting-power-bi-content-pack-how-to.md)
### Referens
...
### [Med hjälp av hello Azure-portalen](device-management-azure-portal.md)
...
#### Använd hello klassiska portalen
...
#### [Kod och PowerShell-exempel](active-directory-b2b-code-samples.md)
...
#### [Lägg till en B2B tooa användarroll](active-directory-b2b-add-guest-to-role.md)
...
#### [Licensiering](active-directory-b2b-licensing.md)
...
#### [Förstå hello B2B-användare](active-directory-b2b-user-properties.md)
...
#### [Jämför B2B-samarbete tooB2C](active-directory-b2b-compare-b2c.md)
...
#### [Ställ in åtkomst tooconnected appar](active-directory-conditional-access-policy-connected-applications.md)
