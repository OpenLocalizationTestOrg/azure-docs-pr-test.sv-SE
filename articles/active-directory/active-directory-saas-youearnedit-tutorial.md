...
I kursen får du lära dig hur toointegrate YouEarnedIt med Azure Active Directory (AD Azure).

Integrera YouEarnedIt med Azure AD ger dig hello följande fördelar:

- Du kan styra i Azure AD som har åtkomst till tooYouEarnedIt.
- Du kan låta dina användare tooautomatically get inloggade tooYouEarnedIt (Single Sign-On) med sina Azure AD-konton.
...
tooconfigure Azure AD-integrering med YouEarnedIt, behöver du hello följande objekt:
...
1. Att lägga till YouEarnedIt från hello-galleriet
2. Konfigurera och testa Azure AD enkel inloggning

## <a name="adding-youearnedit-from-hello-gallery"></a>Att lägga till YouEarnedIt från hello-galleriet
tooconfigure hello integrering av YouEarnedIt i Azure AD, behöver du tooadd YouEarnedIt hello galleriet tooyour listan över hanterade SaaS-appar.

**tooadd YouEarnedIt från galleriet hello utför hello följande steg:**
...
4. Skriv i sökrutan hello **YouEarnedt**väljer **YouEarnedt** resultatet-panelen klickar **Lägg till** knappen tooadd hello program.
...
För enkel inloggning toowork måste Azure AD tooknow vilka hello motsvarighet användaren i YouEarnedIt är tooa i Azure AD. Med andra ord måste en länk mellan en Azure AD-användare och hello relaterade användare i YouEarnedIt toobe upprättas.

I YouEarnedIt, tilldela hello värdet för hello **användarnamn** i Azure AD som hello värde för hello **användarnamn** tooestablish hello länken relationen.

tooconfigure och testa Azure AD enkel inloggning med YouEarnedIt, behöver du toocomplete hello följande byggblock:
...
3. **[Skapa en testanvändare YouEarnedIt](#create-a-youearnedit-test-user)**  -toohave en motsvarighet för Britta Simon i YouEarnedIt som är länkade toohello Azure AD-representation av användaren.
...
I det här avsnittet Aktivera Azure AD enkel inloggning i hello Azure-portalen och konfigurera enkel inloggning i ditt YouEarnedIt program.

**Utför följande steg hello tooconfigure Azure AD enkel inloggning med YouEarnedIt:**

1. I hello Azure-portalen på hello **YouEarnedIt** integreringssidan för programmet, klickar du på **enkel inloggning**.
...
3. På hello **YouEarnedIt domän och URL: er** avsnittet, utföra hello följande steg:
    ...
    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med hello faktiska inloggnings-URL och identifierare. Kontakta [YouEarnedIt klienten supportteamet](https://youearnedit.freshdesk.com/support/tickets/new) tooget dessa värden. 
...
6. På hello **YouEarnedIt Configuration** klickar du på **konfigurera YouEarnedIt** tooopen **konfigurera inloggning** fönster. Kopiera hello **SAML enkel inloggning Tjänstwebbadress** från hello **Snabbreferens avsnitt.**

    ![YouEarnedIt konfiguration](./media/active-directory-saas-youearnedit-tutorial/tutorial_youearnedit_configure.png) 

7. tooconfigure enkel inloggning på **YouEarnedIt** sida, behöver du toosend hello hämtas **Certificate(Base64)** och **SAML inloggning tjänst-URL för enkel** för[YouEarnedIt supportteamet](https://youearnedit.freshdesk.com/support/tickets/new). De kan ange den här inställningen toohave hello SAML SSO anslutningen korrekt på båda sidor.
...
I det här avsnittet skapar du en användare som kallas Britta Simon i YouEarnedIt. Se tillsammans med YouEarnedIt support-teamet tooadd hello användare i hello YouEarnedIt plattform.

>[!NOTE]
>YouEarnedIt räknar hello identitetsleverantör toosupply en e-postadress eller ett användarnamn i hello NameID attribut. Autentiseringen misslyckas om en motsvarande användarnamn eller e-postadress finns inte i hello databas eller inte matchar varandra exakt. Detta kräver att konton importeras till hello YouEarnedIt systemet innan hello SSO-integration (vanligtvis antingen via API: et eller CSV-import).

### <a name="assign-hello-azure-ad-test-user"></a>Tilldela användare hello Azure AD

I det här avsnittet kan aktivera du Britta Simon toouse Azure enkel inloggning genom att bevilja åtkomst tooYouEarnedIt.

![Tilldela hello användarroll][200] 

**tooassign Britta Simon tooYouEarnedIt utför hello följande steg:**

1. I hello Azure-portalen, öppna hello program visa och navigera toohello directory vy och gå för**företagsprogram** Klicka **alla program**.

    ![Tilldela användare][201] 

2. Välj i listan med program hello **YouEarnedIt**.
...
Du bör få automatiskt inloggade tooyour YouEarnedIt programmet när du klickar på hello YouEarnedIt panelen i hello åtkomstpanelen.
