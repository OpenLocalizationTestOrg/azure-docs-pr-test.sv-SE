...
> [!IMPORTANT]
> Microsoft rekommenderar att du hanterar Azure AD via [Azure AD administratörscenter](https://aad.portal.azure.com) på Azure Portal istället för via den klassiska Azure-portalen som nämns i den här artikeln. Att lägga till företagets domännamn i Azure AD Administrationscenter, se [Tilldela administratörsroller i Azure Active Directory](active-directory-domains-add-azure-portal.md).
