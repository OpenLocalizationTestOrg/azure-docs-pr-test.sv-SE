...
I kursen får du lära dig hur toointegrate Kantega SSO för JIRA med Azure Active Directory (AD Azure).

Integrera Kantega SSO för JIRA med Azure AD ger dig hello följande fördelar:

- Du kan styra i Azure AD som har åtkomst tooKantega enkel inloggning för JIRA
- Du kan aktivera din användare tooautomatically get inloggade tooKantega enkel inloggning för JIRA (Single Sign-On) med sina Azure AD-konton
...
tooconfigure Azure AD-integrering med Kantega SSO för JIRA måste hello följande objekt:
...
1. Att lägga till Kantega SSO för JIRA från hello-galleriet
2. Konfigurera och testa Azure AD enkel inloggning

## <a name="adding-kantega-sso-for-jira-from-hello-gallery"></a>Att lägga till Kantega SSO för JIRA från hello-galleriet
tooconfigure hello integrering av Kantega SSO för JIRA i Azure AD, behöver du tooadd Kantega SSO för JIRA hello galleriet tooyour listan över hanterade SaaS-appar.

**tooadd Kantega SSO för JIRA från galleriet hello utför hello följande steg:**
...
4. Skriv i sökrutan hello **Kantega SSO för JIRA**.
...
5. Markera hello resultat på panelen **Kantega SSO för JIRA**, och klicka sedan på **Lägg till** knappen tooadd hello program.
...
För enkel inloggning toowork måste Azure AD tooknow vilka hello motsvarighet användaren Kantega SSO för JIRA är tooa i Azure AD. Med andra ord måste en länk mellan en Azure AD-användare och hello relaterade användaren Kantega SSO för JIRA toobe upprättas.

Kantega SSO för JIRA, tilldela hello värdet för hello **användarnamn** i Azure AD som hello värde för hello **användarnamn** tooestablish hello länken relationen.

tooconfigure och testa Azure AD enkel inloggning med Kantega SSO för JIRA, behöver du toocomplete hello följande byggblock:

1. **[Konfigurera Azure AD enkel inloggning](#configuring-azure-ad-single-sign-on)**  -tooenable användare-toouse den här funktionen.
2. **[Skapa en Azure AD-testanvändare](#creating-an-azure-ad-test-user)**  -tootest Azure AD enkel inloggning med Britta Simon.
3. **[Skapa en Kantega SSO för JIRA testanvändare](#creating-a-kantega-sso-for-jira-test-user)**  -toohave en motsvarighet för Britta Simon Kantega SSO för JIRA som är länkade toohello Azure AD-representation av användaren.
4. **[Tilldela hello Azure AD-testanvändare](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD enkel inloggning.
5. **[Testa enkel inloggning](#testing-single-sign-on)**  -tooverify hello om konfigurationen fungerar.

### <a name="configuring-azure-ad-single-sign-on"></a>Konfigurera Azure AD enkel inloggning

I det här avsnittet Aktivera Azure AD enkel inloggning i hello Azure-portalen och konfigurera enkel inloggning i din Kantega SSO för JIRA program.

**tooconfigure Azure AD enkel inloggning med Kantega SSO för JIRA, utför följande steg hello:**

1. I hello Azure-portalen på hello **Kantega SSO för JIRA** integreringssidan för programmet, klickar du på **enkel inloggning**.
...
3. I **IDP** initierade läge på hello **Kantega SSO JIRA domän och URL: er** avsnittet utföra hello följande steg:
...
4. I **SP** initierade läge, kontrollera **visa avancerade inställningar för URL: en** och utföra hello följande steg:
    ...
    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med hello faktiska identifierare, Reply URL och inloggnings-URL. Dessa värden tas emot under hello konfigurationen av Jira plugin som beskrivs senare i hello kursen.
...
7. Logga in tooyour JIRA på lokal server som administratör i ett annat webbläsarfönster.
...
9. Klicka under tillägg fliken avsnitt **söka efter nya tillägg**. Sök **Kantega SSO för JIRA (SAML & Kerberos)** och på **installera** knappen tooinstall hello ny SAML-plugin-programmet.
...
13. Nytt plugin-program visas under **INTEGRERINGAR**. Klicka på **konfigurera** tooconfigure hello nytt plugin-program.
...
16. På hello **appegenskaper** avsnittet, gör du följande: 
    ...
    a. Kopiera hello **App-ID URI** värde och använda det som **identifierare, Reply URL och inloggnings-URL** på hello **Kantega SSO JIRA domän och URL: er** avsnitt i Azure-portalen.
...
20. På hello **JIRA användarkonton** avsnittet, gör du följande:

    ![Konfigurera enkel inloggning](./media/active-directory-saas-kantegassoforjira-tutorial/addon10.png)

    a. Välj **skapa användare i JIRAS interna katalogen om det behövs** och ange hello rätt namn i hello gruppen för användare (kan vara flera Nej. av (grupper avgränsade med kommatecken).
...
tooenable Azure AD-användare toolog i tooJIRA, måste de etableras i JIRA. Kantega SSO för JIRA är etablering en manuell aktivitet.

**tooprovision ett användarkonto, utför följande steg hello:**

1. Logga in tooyour JIRA på lokal server som administratör.
...
4. På hello **”skapa nya användare”** dialogrutan utför hello följande steg:
...
I det här avsnittet kan aktivera du Britta Simon toouse Azure enkel inloggning genom att bevilja åtkomst tooKantega enkel inloggning för JIRA.

![Tilldela användare][200] 

**tooassign Britta Simon tooKantega SSO för JIRA, utför följande steg hello:**

1. I hello Azure-portalen, öppna hello program visa och navigera toohello directory vy och gå för**företagsprogram** Klicka **alla program**.

    ![Tilldela användare][201] 

2. Välj i listan med program hello **Kantega SSO för JIRA**.
...
När du klickar på hello Kantega SSO för JIRA panelen i hello åtkomstpanelen bör du hämta automatiskt inloggade tooyour Kantega SSO för JIRA program.
