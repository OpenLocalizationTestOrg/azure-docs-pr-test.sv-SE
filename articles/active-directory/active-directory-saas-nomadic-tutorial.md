...
I kursen får du lära dig hur toointegrate Nomadic med Azure Active Directory (AD Azure).

Integrera Nomadic med Azure AD ger dig hello följande fördelar:

- Du kan styra i Azure AD som har åtkomst till tooNomadic.
- Du kan låta dina användare tooautomatically get inloggade tooNomadic (Single Sign-On) med sina Azure AD-konton.
...
tooconfigure Azure AD-integrering med Nomadic, behöver du hello följande objekt:
...
1. Lägg till Nomadic från hello-galleriet
2. Konfigurera och testa Azure AD enkel inloggning

## <a name="add-nomadic-from-hello-gallery"></a>Lägg till Nomadic från hello-galleriet
tooconfigure hello integrering av Nomadic i Azure AD, behöver du tooadd Nomadic hello galleriet tooyour listan över hanterade SaaS-appar.

**tooadd Nomadic från galleriet hello utför hello följande steg:**
...
4. Skriv i sökrutan hello **Nomadic**väljer **Nomadic** resultatet-panelen klickar **Lägg till** knappen tooadd hello program.
...
För enkel inloggning toowork måste Azure AD tooknow vilka hello motsvarighet användaren i Nomadic är tooa i Azure AD. Med andra ord måste en länk mellan en Azure AD-användare och hello relaterade användare i Nomadic toobe upprättas.

I Nomadic, tilldela hello värdet för hello **användarnamn** i Azure AD som hello värde för hello **användarnamn** tooestablish hello länken relationen.

tooconfigure och testa Azure AD enkel inloggning med Nomadic, behöver du toocomplete hello följande byggblock:
...
3. **[Skapa en Nomadic testanvändare](#create-a-nomadic-test-user)**  -toohave en motsvarighet för Britta Simon i Nomadic som är länkade toohello Azure AD-representation av användaren.
...
I det här avsnittet Aktivera Azure AD enkel inloggning i hello Azure-portalen och konfigurera enkel inloggning i ditt Nomadic program.

**Utför följande steg hello tooconfigure Azure AD enkel inloggning med Nomadic:**

1. I hello Azure-portalen på hello **Nomadic** integreringssidan för programmet, klickar du på **enkel inloggning**.
...
3. På hello **Nomadic domän och URL: er** avsnittet, utföra hello följande steg:
    ...
    a. I hello **inloggnings-URL** textruta, ange ett URL-Adressen med hello följer mönstret:`https://<company name>.nomadic.fm/signin`

    b. I hello **identifierare** textruta, ange ett URL-Adressen med hello följer mönstret: `https://<company name>.nomadic.fm/auth/saml2/sp`,`https://<company name>.staging.nomadic.fm/auth/saml2/sp`

    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med hello faktiska inloggnings-URL och identifierare. Kontakta [Nomadic klienten supportteamet](mailto:help@nomadic.fm) tooget dessa värden. 
...
6.  tooget SSO konfigurerats för ditt program bör du kontakta [Nomadic supportteamet](mailto:help@nomadic.fm) och ge dem hello hämtas **metadata**.
...
I det här avsnittet skapar du en användare som kallas Britta Simon i Nomadic. Se tillsammans med [Nomadic supportteamet](mailto:help@nomadic.fm) tooadd hello användare i hello Nomadic plattform.

### <a name="assign-hello-azure-ad-test-user"></a>Tilldela användare hello Azure AD

I det här avsnittet kan aktivera du Britta Simon toouse Azure enkel inloggning genom att bevilja åtkomst tooNomadic.

![Tilldela hello användarroll][200] 

**tooassign Britta Simon tooNomadic utför hello följande steg:**

1. I hello Azure-portalen, öppna hello program visa och navigera toohello directory vy och gå för**företagsprogram** Klicka **alla program**.

    ![Tilldela användare][201] 

2. Välj i listan med program hello **Nomadic**.
...
När du klickar på hello Nomadic panelen i Hej åtkomstpanelen, du får automatiskt inloggade tooyour Nomadic program.
