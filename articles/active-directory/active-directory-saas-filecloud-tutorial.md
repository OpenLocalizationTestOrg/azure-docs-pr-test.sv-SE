...
I kursen får du lära dig hur toointegrate FileCloud med Azure Active Directory (AD Azure).

Integrera FileCloud med Azure AD ger dig hello följande fördelar:

- Du kan styra i Azure AD som har åtkomst till tooFileCloud.
- Du kan låta dina användare tooautomatically get inloggade tooFileCloud (Single Sign-On) med sina Azure AD-konton.
...
tooconfigure Azure AD-integrering med FileCloud, behöver du hello följande objekt:
...
1. Att lägga till FileCloud från hello-galleriet
2. Konfigurera och testa Azure AD enkel inloggning

## <a name="adding-filecloud-from-hello-gallery"></a>Att lägga till FileCloud från hello-galleriet
tooconfigure hello integrering av FileCloud i Azure AD, behöver du tooadd FileCloud hello galleriet tooyour listan över hanterade SaaS-appar.

**tooadd FileCloud från galleriet hello utför hello följande steg:**
...
4. Skriv i sökrutan hello **FileCloud**väljer **FileCloud** resultatet-panelen klickar **Lägg till** knappen tooadd hello program.
...
För enkel inloggning toowork måste Azure AD tooknow vilka hello motsvarighet användaren i FileCloud är tooa i Azure AD. Med andra ord måste en länk mellan en Azure AD-användare och hello relaterade användare i FileCloud toobe upprättas.

I FileCloud, tilldela hello värdet för hello **användarnamn** i Azure AD som hello värde för hello **användarnamn** tooestablish hello länken relationen.

tooconfigure och testa Azure AD enkel inloggning med FileCloud, behöver du toocomplete hello följande byggblock:
...
3. **[Skapa en testanvändare FileCloud](#create-a-filecloud-test-user)**  -toohave en motsvarighet för Britta Simon i FileCloud som är länkade toohello Azure AD-representation av användaren.
...
I det här avsnittet Aktivera Azure AD enkel inloggning i hello Azure-portalen och konfigurera enkel inloggning i ditt FileCloud program.

**Utför följande steg hello tooconfigure Azure AD enkel inloggning med FileCloud:**

1. I hello Azure-portalen på hello **FileCloud** integreringssidan för programmet, klickar du på **enkel inloggning**.
...
3. På hello **FileCloud domän och URL: er** avsnittet, utföra hello följande steg:
    ...
    a. I hello **inloggnings-URL** textruta, ange ett URL-Adressen med hello följer mönstret:`https://<subdomain>.filecloudhosted.com`

    b. I hello **identifierare** textruta, ange ett URL-Adressen med hello följer mönstret:`https://<subdomain>.filecloudhosted.com/simplesaml/module.php/saml/sp/metadata.php/default-sp`

    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med hello faktiska inloggnings-URL och identifierare. Kontakta [FileCloud klienten supportteamet](mailto:support@codelathe.com) tooget dessa värden.
...
6. På hello **FileCloud Configuration** klickar du på **konfigurera FileCloud** tooopen **konfigurera inloggning** fönster. Kopiera hello **SAML enhets-ID** från hello **Snabbreferens avsnitt.**

    ![FileCloud konfiguration](./media/active-directory-saas-filecloud-tutorial/tutorial_filecloud_configure.png) 

7. I en annan webbläsarfönstret, inloggning tooyour FileCloud klient som administratör.

8. Klicka på hello vänstra navigeringsfönstret **inställningar**. 
...
11. Klistra in **SAML enhets-ID**, som du har kopierat från Azure-portalen i hello **IdP slutpunkt URL** textruta.

    ![IDP slutet punkt URL: en textruta](./media/active-directory-saas-filecloud-tutorial/tutorial_filecloud_003.png)

12. Öppna metadatafilen hämtade i anteckningar, kopiera hello innehållet i den i Urklipp, och klistra in den toohello **IdP metadata** textruta på **SAML inställningar** panelen.
...
hello syftet med det här avsnittet är toocreate en användare som kallas Britta Simon i FileCloud. FileCloud stöder just-in-time-etablering, vilket är aktiverat som standard. Det finns ingen åtgärd objekt i det här avsnittet. En ny användare skapas under ett försök tooaccess FileCloud om den inte finns.

>[!NOTE]
>Om du behöver toocreate en användare manuellt, måste toocontact hello [FileCloud klienten supportteamet](mailto:support@codelathe.com). 

### <a name="assign-hello-azure-ad-test-user"></a>Tilldela användare hello Azure AD

I det här avsnittet kan aktivera du Britta Simon toouse Azure enkel inloggning genom att bevilja åtkomst tooFileCloud.

![Tilldela hello användarroll][200] 

**tooassign Britta Simon tooFileCloud utför hello följande steg:**

1. I hello Azure-portalen, öppna hello program visa och navigera toohello directory vy och gå för**företagsprogram** Klicka **alla program**.

    ![Tilldela användare][201] 

2. Välj i listan med program hello **FileCloud**.
...
Du bör få automatiskt inloggade tooyour FileCloud programmet när du klickar på hello FileCloud panelen i hello åtkomstpanelen.
