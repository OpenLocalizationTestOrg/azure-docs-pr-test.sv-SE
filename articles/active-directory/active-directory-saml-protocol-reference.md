...
När ett program registreras med Azure AD, registrerar hello apputvecklaren federation-relaterad information med Azure AD. Detta inkluderar hello **omdirigerings-URI** av programmet hello.
