...
Aktivera federerad enkel inloggning (SSO) i din app aktiveras automatiskt när federering via Azure AD för OpenID Connect, SAML 2.0 och WS-Fed. Om slutanvändarna har toosign i trots redan har en befintlig session med Azure AD, är det troligt att din app kan vara felkonfigurerad.

* Om du använder ADAL/MSAL, kontrollera att du har **PromptBehavior** ställa in också**automatisk** snarare än **alltid**.

* Om du utvecklar en mobil app eventuellt ytterligare konfigurationer tooenable asynkrona eller icke-asynkrona enkel inloggning.
...
[Integrera appar tooAzureAD](https://docs.microsoft.com/azure/active-directory/develop/active-directory-integrating-applications)<br>
