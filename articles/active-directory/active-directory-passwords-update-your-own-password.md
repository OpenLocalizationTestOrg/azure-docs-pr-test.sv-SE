...
3. Beroende på hur din IT-avdelning har konfigurerat lösenordsåterställningen visas ett eller flera av följande alternativ. Du eller din IT-personal ifyllda viss information innan du använder artikeln [registrera dig för lösenordsåterställning via självbetjäning](active-directory-passwords-reset-register.md).
