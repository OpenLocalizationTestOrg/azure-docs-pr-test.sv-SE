...
I kursen får du lära dig hur toointegrate Kantega SSO för bambu med Azure Active Directory (AD Azure).

Integrera Kantega SSO för bambu med Azure AD ger dig hello följande fördelar:

- Du kan styra i Azure AD som har åtkomst tooKantega SSO för bambu
- Du kan aktivera din användare tooautomatically get inloggade tooKantega SSO för bambu (Single Sign-On) med sina Azure AD-konton
...
tooconfigure Azure AD-integrering med Kantega SSO för bambu måste hello följande objekt:
...
1. Att lägga till Kantega SSO för bambu från hello-galleriet
2. Konfigurera och testa Azure AD enkel inloggning

## <a name="adding-kantega-sso-for-bamboo-from-hello-gallery"></a>Att lägga till Kantega SSO för bambu från hello-galleriet
tooconfigure hello integrering av Kantega SSO för bambu i Azure AD, behöver du tooadd Kantega SSO för bambu hello galleriet tooyour listan över hanterade SaaS-appar.

**tooadd Kantega SSO för bambu från galleriet hello utför hello följande steg:**
...
4. Skriv i sökrutan hello **Kantega SSO för bambu**.
...
5. Markera hello resultat på panelen **Kantega SSO för bambu**, och klicka sedan på **Lägg till** knappen tooadd hello program.
...
För enkel inloggning toowork måste Azure AD tooknow vilka hello motsvarighet användaren Kantega SSO för bambu är tooa i Azure AD. Med andra ord måste en länk mellan en Azure AD-användare och hello relaterade användaren Kantega SSO för bambu toobe upprättas.

Kantega SSO för bambu, tilldela hello värdet för hello **användarnamn** i Azure AD som hello värde för hello **användarnamn** tooestablish hello länken relationen.

tooconfigure och testa Azure AD enkel inloggning med Kantega SSO för bambu, behöver du toocomplete hello följande byggblock:

1. **[Konfigurera Azure AD enkel inloggning](#configuring-azure-ad-single-sign-on)**  -tooenable användare-toouse den här funktionen.
2. **[Skapa en Azure AD-testanvändare](#creating-an-azure-ad-test-user)**  -tootest Azure AD enkel inloggning med Britta Simon.
3. **[Skapa en Kantega SSO för bambu testanvändare](#creating-a-kantega-sso-for-bamboo-test-user)**  -toohave en motsvarighet för Britta Simon Kantega SSO för bambu som är länkade toohello Azure AD-representation av användaren.
4. **[Tilldela hello Azure AD-testanvändare](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD enkel inloggning.
5. **[Testa enkel inloggning](#testing-single-sign-on)**  -tooverify hello om konfigurationen fungerar.

### <a name="configuring-azure-ad-single-sign-on"></a>Konfigurera Azure AD enkel inloggning

I det här avsnittet Aktivera Azure AD enkel inloggning i hello Azure-portalen och konfigurera enkel inloggning i din Kantega SSO för bambu program.

**tooconfigure Azure AD enkel inloggning med Kantega SSO för bambu, utför följande steg hello:**

1. I hello Azure-portalen på hello **Kantega SSO för bambu** integreringssidan för programmet, klickar du på **enkel inloggning**.
...
3. I **IDP** initierade läge på hello **Kantega SSO bambu domän och URL: er** avsnittet utföra hello följande steg:
...
4. I **SP** initierade läge, kontrollera **visa avancerade inställningar för URL: en** och utföra hello följande steg:
    ...
    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med hello faktiska identifierare, Reply URL och inloggnings-URL. Dessa värden tas emot under hello konfigurationen av bambu plugin-programmet som beskrivs senare i hello kursen.
...
7. Logga in tooyour bambu på lokal server som administratör i ett annat webbläsarfönster.
...
9. Klicka under tillägg fliken avsnitt **söka efter nya tillägg**. Sök **Kantega SSO för bambu (SAML & Kerberos)** och på **installera** knappen tooinstall hello ny SAML-plugin-programmet.

    ![Konfigurera enkel inloggning](./media/active-directory-saas-kantegassoforbamboo-tutorial/addon2.png)

10. hello plugin installationen startar.

    ![Konfigurera enkel inloggning](./media/active-directory-saas-kantegassoforbamboo-tutorial/addon21.png)

11. När hello installationen är klar. Klicka på **Stäng**.
...
14. I hello **SAML** avsnitt. Välj **Azure Active Directory (AD Azure)** från hello **Lägg till identitetsleverantör** listrutan.
...
16. På hello **appegenskaper** avsnittet, gör du följande:

    ![Konfigurera enkel inloggning](./media/active-directory-saas-kantegassoforbamboo-tutorial/addon6.png)

    a. Kopiera hello **App-ID URI** värde och använda det som **identifierare, Reply URL och inloggnings-URL** på hello **Kantega SSO bambu domän och URL: er** avsnitt i Azure-portalen.

    b. Klicka på **Nästa**.

17. På hello **Metadata importera** avsnittet, gör du följande:
...
18. På hello **och enkel inloggning** avsnittet, gör du följande:
...
19. Kontrollera hello signeringscertifikat och klicka på **nästa**.    

    ![Konfigurera enkel inloggning](./media/active-directory-saas-kantegassoforbamboo-tutorial/addon9.png)

20. På hello **bambu användarkonton** avsnittet, gör du följande:

    ![Konfigurera enkel inloggning](./media/active-directory-saas-kantegassoforbamboo-tutorial/addon10.png)

    a. Välj **skapa användare i Bambus interna katalogen om det behövs** och ange hello rätt namn i hello gruppen för användare (kan vara flera Nej. av (grupper avgränsade med kommatecken).
...
22. På hello **kända domäner för Azure AD** avsnittet, gör du följande:   
...
tooenable Azure AD-användare toolog i tooBamboo, måste de etableras i bambu. Kantega SSO för bambu är etablering en manuell aktivitet.

**tooprovision ett användarkonto, utför följande steg hello:**

1. Logga in tooyour bambu på lokal server som administratör.
...
3. Klicka på **användare**. Under hello **Lägg till användare** avsnittet, utför följande steg:
    ...
    b. I hello **lösenord** textruta typen hello lösenord för användare.

    c. I hello **Bekräfta lösenord** textruta hello ange lösenordet för användaren.
    
    d. I hello **fullständiga namn** textruta typen hello användarens som Britta Simon fullständiga namn.
    
    e. I hello **e-post** textruta typen hello användarens e-postadress som Brittasimon@contoso.com.
    
    f. Klicka på **Spara**.

### <a name="assigning-hello-azure-ad-test-user"></a>Tilldela användare hello Azure AD

I det här avsnittet kan aktivera du Britta Simon toouse Azure enkel inloggning genom att bevilja åtkomst tooKantega SSO för bambu.

![Tilldela användare][200] 

**tooassign Britta Simon tooKantega SSO för bambu, utför följande steg hello:**

1. I hello Azure-portalen, öppna hello program visa och navigera toohello directory vy och gå för**företagsprogram** Klicka **alla program**.

    ![Tilldela användare][201] 

2. Välj i listan med program hello **Kantega SSO för bambu**.
...
När du klickar på hello Kantega SSO för bambu panelen i hello åtkomstpanelen bör du hämta automatiskt inloggade tooyour Kantega SSO för bambu program.
