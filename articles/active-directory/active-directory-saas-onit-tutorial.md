...
I kursen får du lära dig hur toointegrate Onit med Azure Active Directory (AD Azure).

Integrera Onit med Azure AD ger dig hello följande fördelar:

- Du kan styra i Azure AD som har åtkomst till tooOnit.
- Du kan låta dina användare tooautomatically get inloggade tooOnit (Single Sign-On) med sina Azure AD-konton.
...
tooconfigure Azure AD-integrering med Onit, behöver du hello följande objekt:
...
1. Att lägga till Onit från hello-galleriet
2. Konfigurera och testa Azure AD enkel inloggning

## <a name="adding-onit-from-hello-gallery"></a>Att lägga till Onit från hello-galleriet
tooconfigure hello integrering av Onit i Azure AD, behöver du tooadd Onit hello galleriet tooyour listan över hanterade SaaS-appar.

**tooadd Onit från galleriet hello utför hello följande steg:**
...
4. Skriv i sökrutan hello **Onit**väljer **Onit** resultatet-panelen klickar **Lägg till** knappen tooadd hello program.
...
För enkel inloggning toowork måste Azure AD tooknow vilka hello motsvarighet användaren i Onit är tooa i Azure AD. Med andra ord måste en länk mellan en Azure AD-användare och hello relaterade användare i Onit toobe upprättas.

I Onit, tilldela hello värdet för hello **användarnamn** i Azure AD som hello värde för hello **användarnamn** tooestablish hello länken relationen.

tooconfigure och testa Azure AD enkel inloggning med Onit, behöver du toocomplete hello följande byggblock:
...
3. **[Skapa en testanvändare Onit](#create-an-onit-test-user)**  -toohave en motsvarighet för Britta Simon i Onit som är länkade toohello Azure AD-representation av användaren.
...
I det här avsnittet Aktivera Azure AD enkel inloggning i hello Azure-portalen och konfigurera enkel inloggning i ditt Onit program.

**Utför följande steg hello tooconfigure Azure AD enkel inloggning med Onit:**

1. I hello Azure-portalen på hello **Onit** integreringssidan för programmet, klickar du på **enkel inloggning**.
...
3. På hello **Onit domän och URL: er** avsnittet, utföra hello följande steg:

    ![URL: er och Onit domän med enkel inloggning information](./media/active-directory-saas-onit-tutorial/tutorial_onit_url.png)

    a. I hello **inloggnings-URL** textruta, ange ett URL-Adressen med hello följer mönstret:`https://<sub-domain>.onit.com`

    b. I hello **identifierare** textruta, ange ett URL-Adressen med hello följer mönstret:`https://<sub-domain>.onit.com`

    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med hello faktiska inloggnings-URL och identifierare. Kontakta [Onit klienten supportteamet](https://www.onit.com/support) tooget dessa värden. 
...
5. Onit program förväntar hello SAML intyg i ett specifikt format. Konfigurera hello följande anspråk för det här programmet. Du kan hantera hello värden för attributen från hello **”Atrribute”** fliken av programmet hello. hello följande skärmbild visar ett exempel för det här. 
...
8. På hello **Onit Configuration** klickar du på **konfigurera Onit** tooopen **konfigurera inloggning** fönster. Kopiera hello **Sign-Out URL, SAML enkel inloggning Tjänstwebbadress** från hello **Snabbreferens avsnitt.**
...
10. Hello-menyn överst hello **Administration**.
...
13. På hello **säkerhet** fliken, utföra hello följande steg:
    ...
    b. I **Idp mål-URL** textruta klistra in hello värdet för **SAML inloggning tjänst-URL för enkel**, som du har kopierat från Azure-portalen.

    c. I **Idp logga ut URL** textruta klistra in hello värdet för **Sign-Out URL**, som du har kopierat från Azure-portalen.

    d. I **Idp Cert fingeravtryck (SHA1)** textruta klistra in hello **tumavtrycket** värdet för certifikat som du har kopierat från Azure-portalen.
...
I ordning tooenable Azure AD-användare toolog i Onit, måste de etableras i Onit.  

Hello gäller Onit är etablering en manuell aktivitet.

**tooconfigure användaretablering, utför följande steg hello:**

1. Logga in tooyour **Onit** företagets webbplats som administratör.
...
3. På hello **Lägg till användare** dialogrutan utför hello följande steg:
  ...
  1. Typen hello **namn** och hello **e-postadress** av ett giltigt Azure AD-kontot som du vill använda tooprovision hello relaterade textrutor.
  2. Klicka på **Skapa**.    
...
I det här avsnittet kan aktivera du Britta Simon toouse Azure enkel inloggning genom att bevilja åtkomst tooOnit.

![Tilldela hello användarroll][200] 

**tooassign Britta Simon tooOnit utför hello följande steg:**

1. I hello Azure-portalen, öppna hello program visa och navigera toohello directory vy och gå för**företagsprogram** Klicka **alla program**.

    ![Tilldela användare][201] 

2. Välj i listan med program hello **Onit**.
...
Du bör få automatiskt inloggade tooyour Onit programmet när du klickar på hello Onit panelen i hello åtkomstpanelen.
