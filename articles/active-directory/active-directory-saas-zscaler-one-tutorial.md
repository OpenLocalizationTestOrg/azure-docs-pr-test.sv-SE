...
I kursen får du lära dig hur toointegrate Zscaler en med Azure Active Directory (AD Azure).

Integrera en Zscaler med Azure AD ger dig hello följande fördelar:

- Du kan styra i Azure AD som har åtkomst tooZscaler en
- Du kan aktivera din användare tooautomatically get inloggade tooZscaler en (Single Sign-On) med sina Azure AD-konton
...
tooconfigure Azure AD-integrering med en Zscaler måste hello följande objekt:
...
1. Att lägga till en Zscaler från hello-galleriet
2. Konfigurera och testa Azure AD enkel inloggning

## <a name="adding-zscaler-one-from-hello-gallery"></a>Att lägga till en Zscaler från hello-galleriet
tooconfigure hello integrering av en Zscaler i Azure AD, behöver du en Zscaler tooadd hello galleriet tooyour listan över hanterade SaaS-appar.

**tooadd Zscaler en från galleriet hello utför hello följande steg:**
...
4. Skriv i sökrutan hello **Zscaler en**.

    ![Skapa en testanvändare i Azure AD](./media/active-directory-saas-zscaler-one-tutorial/tutorial_zscalerone_search.png)

5. Markera hello resultat på panelen **Zscaler en**, och klicka sedan på **Lägg till** knappen tooadd hello program.
...
För enkel inloggning toowork måste Azure AD tooknow vilka hello motsvarighet användaren i en Zscaler är tooa i Azure AD. Med andra ord måste en länk mellan en Azure AD-användare och hello relaterade användare i en Zscaler toobe upprättas.

I en Zscaler, tilldela hello värdet för hello **användarnamn** i Azure AD som hello värde för hello **användarnamn** tooestablish hello länken relationen.

tooconfigure och testa Azure AD enkel inloggning med en Zscaler, behöver du toocomplete hello följande byggblock:
...
4. **[Skapa en Zscaler en testanvändare](#creating-a-zscaler-one-test-user)**  -toohave en motsvarighet för Britta Simon i Zscaler en som är länkade toohello Azure AD-representation av användaren.
...
I det här avsnittet Aktivera Azure AD enkel inloggning i hello Azure-portalen och konfigurera enkel inloggning i ditt Zscaler ett program.

**Utför följande hello tooconfigure Azure AD enkel inloggning med en Zscaler:**

1. I hello Azure-portalen på hello **Zscaler en** integreringssidan för programmet, klickar du på **enkel inloggning**.
...
3. På hello **Zscaler en domän och URL: er** avsnittet, utföra hello följande steg:

    ![Konfigurera enkel inloggning](./media/active-directory-saas-zscaler-one-tutorial/tutorial_zscalerone_url.png)

    Ange hello-URL som används av dina användare toosign på tooyour Zscaler ett program i hello inloggnings-URL-textrutan.

    > [!NOTE] 
    > Du har tooupdate värdet med hello faktiska inloggnings-URL. Kontakta [Zscaler en klient supportteamet](https://www.zscaler.com/company/contact) tooget dessa värden.
...
6. På hello **Zscaler en konfiguration** klickar du på **konfigurera Zscaler en** tooopen **konfigurera inloggning** fönster. Kopiera hello **SAML enkel inloggning Tjänstwebbadress** från hello **Snabbreferens avsnitt.**

    ![Konfigurera enkel inloggning](./media/active-directory-saas-zscaler-one-tutorial/tutorial_zscalerone_configure.png) 

7. Logga in tooyour Zscaler en företagets plats som en administratör i en annan webbläsarfönster.
...
tooenable Azure AD-användare toolog i tooZscaler en, måste de vara etablerade tooZscaler en. Hello gäller en Zscaler är etablering en manuell aktivitet.
...
1. Logga in tooyour **Zscaler en** klient.
...
> [!NOTE]
> Du kan använda något annat Zscaler en användare konto skapas verktyg eller API: er som tillhandahålls av en Zscaler tooprovision användarkonton i Azure AD.

### <a name="assigning-hello-azure-ad-test-user"></a>Tilldela användare hello Azure AD

I det här avsnittet kan aktivera du Britta Simon toouse Azure enkel inloggning genom att bevilja åtkomst tooZscaler en.

![Tilldela användare][200] 

**tooassign Britta Simon tooZscaler, utför följande steg hello:**

1. I hello Azure-portalen, öppna hello program visa och navigera toohello directory vy och gå för**företagsprogram** Klicka **alla program**.

    ![Tilldela användare][201] 

2. Välj i listan med program hello **Zscaler en**.
...
Du bör få automatiskt inloggade tooyour Zscaler ett program när du klickar på hello Zscaler en panel i hello åtkomstpanelen.
