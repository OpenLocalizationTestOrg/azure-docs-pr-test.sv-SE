...
Microsoft-Teams bygger kraftigt på Exchange Online och SharePoint Online för huvudscenarier produktivitet som möten, kalendrar och fildelning. Principer för villkorlig åtkomst som ställs för dessa molnappar gäller för Microsoft-Teams när en användare loggar in.

Microsoft-Teams även stöds separat som en molnapp i Azure Active Directory-principer för villkorlig åtkomst. Principer för certifikat som har angetts för en molnappen gäller för Microsoft-Teams när en användare loggar in.
