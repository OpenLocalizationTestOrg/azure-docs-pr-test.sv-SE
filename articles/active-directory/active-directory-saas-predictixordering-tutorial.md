...
I kursen får du lära dig hur toointegrate Predictix ordning med Azure Active Directory (AD Azure).

Integrera Predictix ordning med Azure AD ger dig hello följande fördelar:

- Du kan styra i Azure AD som har åtkomst tooPredictix ordning.
- Du kan aktivera din användare tooautomatically get inloggade tooPredictix gruppering (Single Sign-On) med sina Azure AD-konton.
...
tooconfigure Azure AD-integrering med Predictix ordning, behöver du hello följande objekt:
...
1. Att lägga till Predictix ordning från hello-galleriet
2. Konfigurera och testa Azure AD enkel inloggning

## <a name="adding-predictix-ordering-from-hello-gallery"></a>Att lägga till Predictix ordning från hello-galleriet
tooconfigure hello integrering av Predictix ordning i Azure AD, behöver du tooadd Predictix ordning hello galleriet tooyour listan över hanterade SaaS-appar.

**tooadd Predictix ordning från galleriet hello utför hello följande steg:**
...
4. Skriv i sökrutan hello **Predictix ordning**väljer **Predictix ordning** resultatet-panelen klickar **Lägg till** knappen tooadd hello program.
...
För enkel inloggning toowork måste Azure AD tooknow vilka hello motsvarighet användaren i Predictix ordning är tooa i Azure AD. Med andra ord måste en länk mellan en Azure AD-användare och hello relaterade användare i Predictix ordning toobe upprättas.

Tilldela hello värdet hello beställning av Predictix **användarnamn** i Azure AD som hello värde för hello **användarnamn** tooestablish hello länken relationen.

tooconfigure och testa Azure AD enkel inloggning med Predictix ordning, behöver du toocomplete hello följande byggblock:
...
3. **[Skapa en testanvändare Predictix ordning](#create-a-predictix-ordering-test-user)**  -toohave en motsvarighet för Britta Simon i Predictix ordning som är länkade toohello Azure AD-representation av användaren.
...
I det här avsnittet Aktivera Azure AD enkel inloggning i hello Azure-portalen och konfigurera enkel inloggning i tillämpningsprogrammet Predictix ordning.

**Utför följande hello tooconfigure Azure AD enkel inloggning med Predictix ordning:**

1. I hello Azure-portalen på hello **Predictix ordning** integreringssidan för programmet, klickar du på **enkel inloggning**.
...
3. På hello **Predictix beställa domän och URL: er** avsnittet, utföra hello följande steg:
    ...
    a. I hello **inloggnings-URL** textruta, ange ett URL-Adressen med hello följer mönstret:`https://<companyname-pricing>.ordering.predictix.com/sso/request`
    ...
    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med hello faktiska inloggnings-URL och identifierare. Kontakta [Predictix ordning klienten supportteamet](https://www.predix.io/support/) tooget dessa värden. 
...
6. På hello **Predictix ordning Configuration** klickar du på **konfigurera Predictix ordning** tooopen **konfigurera inloggning** fönster. Kopiera hello **Sign-Out URL, SAML enhets-ID och SAML enkel inloggning Tjänstwebbadress** från hello **Snabbreferens avsnitt.**
...
7. tooconfigure enkel inloggning på **Predictix ordning** sida, behöver du toosend hello hämtas **certifikat (Base64)**, **Sign-Out URL, SAML enhets-ID och SAML enkel inloggning tjänst-URL**  för[Predictix ordning supportteamet](https://www.predix.io/support/). De kan ange den här inställningen toohave hello SAML SSO anslutningen korrekt på båda sidor.
...
I det här avsnittet kan du skapa en användare som kallas Britta Simon i Predictix ordning. Arbeta med [Predictix ordning supportteamet](https://www.predix.io/support/) tooadd hello användare i hello Predictix ordning plattform.

### <a name="assign-hello-azure-ad-test-user"></a>Tilldela användare hello Azure AD

I det här avsnittet kan du aktivera Britta Simon toouse Azure enkel inloggning genom att bevilja åtkomst tooPredictix ordning.

![Tilldela hello användarroll][200] 

**tooassign Britta Simon tooPredictix ordning, utföra hello följande steg:**

1. I hello Azure-portalen, öppna hello program visa och navigera toohello directory vy och gå för**företagsprogram** Klicka **alla program**.

    ![Tilldela användare][201] 

2. Välj i listan med program hello **Predictix ordning**.
...
Du bör få automatiskt inloggade tooyour Predictix ordning programmet när du klickar på hello Predictix ordning panelen i hello åtkomstpanelen.
