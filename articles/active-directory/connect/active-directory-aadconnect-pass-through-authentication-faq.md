...
>[!IMPORTANT]
>Funktionen direkt-autentisering är för närvarande under förhandsgranskning.
...
Direkt-autentisering är en kostnadsfri funktion och du behöver inte några betald utgåvor av Azure AD för att använda den. Den återstående ledigt när funktionen når allmän tillgänglighet.
...
Nej, hash-synkronisering av lösenord är inte en allmän användning av direkt-autentisering. Det fungerar endast som en reserv för [scenarier som inte stöder direkt autentiseringen idag](active-directory-aadconnect-pass-through-authentication-current-limitations.md#unsupported-scenarios). Om du vill undvika användaren logga in fel, bör du konfigurera direkt autentisering för [hög tillgänglighet](active-directory-aadconnect-pass-through-authentication-quick-start.md#step-5-ensure-high-availability).
...
Nej, installera flera direkt autentisering agenter garanterar [hög tillgänglighet](active-directory-aadconnect-pass-through-authentication-quick-start.md#step-5-ensure-high-availability), men inte belastningsutjämning. En eller två agenter för autentisering kan det sluta hantera flesta inloggning-begäranden.

Lösenord verifiering begäranden som agenter för autentisering behöver hantera är förenklad. Därför hanteras belastning och genomsnittlig belastning för de flesta kunder enkelt kan av två eller tre autentisering agenter totalt.
