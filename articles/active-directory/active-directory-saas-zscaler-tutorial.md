...
I kursen får du lära dig hur toointegrate Zscaler med Azure Active Directory (AD Azure).

Integrera Zscaler med Azure AD ger dig hello följande fördelar:

- Du kan styra i Azure AD som har åtkomst till tooZscaler
- Du kan aktivera din användare tooautomatically get inloggade tooZscaler (Single Sign-On) med sina Azure AD-konton
...
tooconfigure Azure AD-integrering med Zscaler, behöver du hello följande objekt:
...
1. Att lägga till Zscaler från hello-galleriet
2. Konfigurera och testa Azure AD enkel inloggning

## <a name="adding-zscaler-from-hello-gallery"></a>Att lägga till Zscaler från hello-galleriet
tooconfigure hello integrering av Zscaler i Azure AD, behöver du tooadd Zscaler hello galleriet tooyour listan över hanterade SaaS-appar.

**tooadd Zscaler från galleriet hello utför hello följande steg:**
...
4. Skriv i sökrutan hello **Zscaler**.

    ![Skapa en testanvändare i Azure AD](./media/active-directory-saas-zscaler-tutorial/tutorial_zscaler_search.png)

5. Markera hello resultat på panelen **Zscaler**, och klicka sedan på **Lägg till** knappen tooadd hello program.
...
För enkel inloggning toowork måste Azure AD tooknow vilka hello motsvarighet användaren i Zscaler är tooa i Azure AD. Med andra ord måste en länk mellan en Azure AD-användare och hello relaterade användare i Zscaler toobe upprättas.

I Zscaler, tilldela hello värdet för hello **användarnamn** i Azure AD som hello värde för hello **användarnamn** tooestablish hello länken relationen.

tooconfigure och testa Azure AD enkel inloggning med Zscaler, behöver du toocomplete hello följande byggblock:
...
4. **[Skapa en testanvändare Zscaler](#creating-a-zscaler-test-user)**  -toohave en motsvarighet för Britta Simon i Zscaler som är länkade toohello Azure AD-representation av användaren.
...
I det här avsnittet Aktivera Azure AD enkel inloggning i hello Azure-portalen och konfigurera enkel inloggning i ditt Zscaler program.

**Utför följande steg hello tooconfigure Azure AD enkel inloggning med Zscaler:**

1. I hello Azure-portalen på hello **Zscaler** integreringssidan för programmet, klickar du på **enkel inloggning**.
...
3. På hello **Zscaler domän och URL: er** avsnittet, utföra hello följande steg:

    ![Konfigurera enkel inloggning](./media/active-directory-saas-zscaler-tutorial/tutorial_zscaler_url.png)

    I hello **inloggnings-URL** textruta, ange ett URL-Adressen med hello följer mönstret:`https://<companyname>.zsclaer.net`

    > [!NOTE] 
    > Det här värdet är inte verkliga. Uppdatera det här värdet med hello faktiska inloggnings-URL. Kontakta [Zscaler klienten supportteamet](https://www.zscaler.com/company/contact) tooget det här värdet. 
...
6. På hello **Zscaler Configuration** klickar du på **konfigurera Zscaler** tooopen **konfigurera inloggning** fönster. Kopiera hello **SAML enkel inloggning Tjänstwebbadress** från hello **Snabbreferens avsnitt.**

    ![Konfigurera enkel inloggning](./media/active-directory-saas-zscaler-tutorial/tutorial_zscaler_configure.png) 

7. Logga in tooyour ZScaler företagets webbplats som en administratör i en annan webbläsarfönster.
...
5. I hello avsnittet för Proxy-server, utför hello följande steg:   
    ...
    b. Skriv i hello adress textruta **gateway.zscaler.net**.
...
tooenable Azure AD-användare toolog i tooZScaler, måste de vara etablerade tooZScaler.  
Hello gäller ZScaler är etablering en manuell aktivitet.
...
> [!NOTE]
> Du kan använda något annat ZScaler användarens konto skapas verktyg eller API: er som tillhandahålls av ZScaler tooprovision AAD-användarkonton.

### <a name="assigning-hello-azure-ad-test-user"></a>Tilldela användare hello Azure AD

I det här avsnittet kan aktivera du Britta Simon toouse Azure enkel inloggning genom att bevilja åtkomst tooZscaler.

![Tilldela användare][200] 

**tooassign Britta Simon tooZscaler utför hello följande steg:**

1. I hello Azure-portalen, öppna hello program visa och navigera toohello directory vy och gå för**företagsprogram** Klicka **alla program**.

    ![Tilldela användare][201] 

2. Välj i listan med program hello **Zscaler**.
...
Du bör få automatiskt inloggade tooyour Zscaler programmet när du klickar på hello Zscaler panelen i hello åtkomstpanelen.
