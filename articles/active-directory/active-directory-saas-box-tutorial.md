...
4. I sökrutan skriver **rutan**.

    ![Skapa en testanvändare i Azure AD](./media/active-directory-saas-box-tutorial/tutorial_box_search.png)

5. Välj i resultatpanelen **rutan**, och klicka sedan på **Lägg till** för att lägga till programmet.
...
Den här länken relationen upprättas genom att tilldela värdet för den **användarnamn** i Azure AD som värde för den **användarnamn** i rutan.
...
3. **[Skapa en testanvändare i rutan](#creating-a-box-test-user)**  – du har en motsvarighet för Britta Simon i som är kopplad till Azure AD-representation av användaren.
...
3. På den **rutan domän och URL: er** avsnittet, utför följande steg:
    ...
    I den **inloggnings-URL** textruta Skriv en URL med följande mönster:`https://<subdomain>.box.com`
