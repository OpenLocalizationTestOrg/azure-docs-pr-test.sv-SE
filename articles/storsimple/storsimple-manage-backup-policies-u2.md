...
---
# <a name="use-hello-storsimple-manager-service-toomanage-backup-policies-update-2"></a>Använd hello StorSimple Manager-tjänsten toomanage principer för säkerhetskopiering (uppdatering 2)
