...
Välkommen till distribution av tooMicrosoft Azure StorSimple-enheten. De här kurserna om distribution gäller tooStorSimple 8000-serien uppdatering 1.0. Denna serie självstudier beskriver hur tooconfigure din StorSimple-enhet och innehåller en checklista för konfiguration, konfigurationskrav och detaljerade konfigurationssteg steg.
