...
1. Öppna hello klassiska Azure-portalen.
2. Navigera för**enheter** > **Underhåll** > **maskinvarustatus**, och kontrollera att hello status för hello LETT för hello active EBOD domänkontrollanten modulen är grön och hello Indikator för hello misslyckades EBOD domänkontrollant modulen är röda.
