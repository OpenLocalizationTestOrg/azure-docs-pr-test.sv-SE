...
* Inga virtuella datorer eller instanser i [Skaluppsättning är felfria](#unhealthy-instances-in-backendaddresspool).
* Backend-virtuella datorer eller instanser av Skaluppsättning [inte svarar på hälsoavsökningen standard](#problems-with-default-health-probe.md).
...
Om Application Gateway inte har några virtuella datorer eller VM Scale Set konfigurerats i backend-adresspool, det går inte att vidarebefordra alla kundbegäran och genererar en felaktig gateway-fel.
