...
---
# <a name="query-data-from-the-azure-time-series-insights-environment-using-c"></a><span data-ttu-id="4c53c-103">Fråga efter data från Azure tid serien Insights-miljön med hjälp av C#</span><span class="sxs-lookup"><span data-stu-id="4c53c-103">Query data from the Azure Time Series Insights environment using C#</span></span>

<span data-ttu-id="4c53c-104">Den här C#-exempel visar hur du frågar efter data från Azure tid serien Insights-miljön.</span><span class="sxs-lookup"><span data-stu-id="4c53c-104">This C# example demonstrates how to query data from the Azure Time Series Insights environment.</span></span>
<span data-ttu-id="4c53c-105">Exemplet visar flera grundläggande exempel på användning av fråge-API:</span><span class="sxs-lookup"><span data-stu-id="4c53c-105">The sample shows several basic examples of Query API usage:</span></span>
1. <span data-ttu-id="4c53c-106">Hämta åtkomsttoken via Azure Active Directory-API som en förberedelse steg.</span><span class="sxs-lookup"><span data-stu-id="4c53c-106">As a preparation step, acquire the access token through the Azure Active Directory API.</span></span> <span data-ttu-id="4c53c-107">Skicka detta token i den `Authorization` huvudet i varje fråga API-begäran.</span><span class="sxs-lookup"><span data-stu-id="4c53c-107">Pass this token in the `Authorization` header of every Query API request.</span></span> <span data-ttu-id="4c53c-108">För att ställa in icke-interaktiva program, se [autentisering och auktorisering](time-series-insights-authentication-and-authorization.md).</span><span class="sxs-lookup"><span data-stu-id="4c53c-108">For setting up non-interactive applications, see [Authentication and authorization](time-series-insights-authentication-and-authorization.md).</span></span> <span data-ttu-id="4c53c-109">Kontrollera också att alla konstanter som definierats i början av exemplet är rätt inställda.</span><span class="sxs-lookup"><span data-stu-id="4c53c-109">Also, ensure all the constants defined at the beginning of the sample are correctly set.</span></span>
2. <span data-ttu-id="4c53c-110">Hämta listan över miljöer som användaren har åtkomst till.</span><span class="sxs-lookup"><span data-stu-id="4c53c-110">The list of environments that the user has access to is obtained.</span></span> <span data-ttu-id="4c53c-111">En av miljöerna hämtas som miljön intressanta och ytterligare data efterfrågas för den här miljön.</span><span class="sxs-lookup"><span data-stu-id="4c53c-111">One of the environments is picked up as the environment of interest, and further data is queried for this environment.</span></span>
3. <span data-ttu-id="4c53c-112">Som ett exempel på en HTTPS-begäran begärs tillgänglighetsdata för den intressanta miljön.</span><span class="sxs-lookup"><span data-stu-id="4c53c-112">As an example of HTTPS request, availability data is requested for the environment of interest.</span></span>
4. <span data-ttu-id="4c53c-113">Som ett exempel på en webbsocket-begäran begärs händelsens aggregerade data för den intressanta miljön.</span><span class="sxs-lookup"><span data-stu-id="4c53c-113">As an example of web socket request, event aggregates data is requested for the environment of interest.</span></span> <span data-ttu-id="4c53c-114">Data krävs för hela tillgänglighetstidsintervallet.</span><span class="sxs-lookup"><span data-stu-id="4c53c-114">Data is requested for the whole availability time range.</span></span>

## <a name="c-example"></a><span data-ttu-id="4c53c-115">C#-exempel</span><span class="sxs-lookup"><span data-stu-id="4c53c-115">C# example</span></span>
...
## <a name="next-steps"></a><span data-ttu-id="4c53c-116">Nästa steg</span><span class="sxs-lookup"><span data-stu-id="4c53c-116">Next steps</span></span>

<span data-ttu-id="4c53c-117">Fullständig fråge-API-referens, finns det [frågan API](/rest/api/time-series-insights/time-series-insights-reference-queryapi) dokumentet.</span><span class="sxs-lookup"><span data-stu-id="4c53c-117">For the full Query API reference, see the [Query API](/rest/api/time-series-insights/time-series-insights-reference-queryapi) document.</span></span>
