...
Det här C#-exemplet visar hur toomanage referensdata för en Azure tid serien Insights-miljö.
Innan du kör hello exemplet kontrollerar du hello följande steg har slutförts.
...
2. hello åtkomst-token används när du kör programmet hello förvärvas via hello Azure Active Directory-API. Denna token ska skickas i hello `Authorization` huvudet i varje fråga API-begäran. Konfigurera icke-interaktiva program finns hello [autentisering och auktorisering](time-series-insights-authentication-and-authorization.md) artikel.
3. Alla hello konstanter som definierats hello början av hello exempel är rätt inställda.
