...
I det här scenariot kan du lära dig hur toocreate ett Azure Redis-Cache.
...
Det här skriptet använder följande kommandon toocreate hello en resursgrupp och ett redis-cache. Varje kommando i hello tabellen länkar toocommand viss dokumentation.
