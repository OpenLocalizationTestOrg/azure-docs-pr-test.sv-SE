...
I detta scenario dig du hur toocreate 6 GB premiumnivån Azure Redis-Cache med kluster aktiverad och två delar.
...
Det här skriptet använder följande kommandon toocreate hello en resursgrupp och Premium-nivån redis-cache med kluster aktivera. Varje kommando i hello tabellen länkar toocommand viss dokumentation.
