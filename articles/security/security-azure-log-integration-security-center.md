...
2. Därefter ska du köra ett kommando som tilldelar reader åtkomst på prenumerationen till tjänstens huvudnamn skapade i steg 2. Om du inte anger en SubscriptionID försöker kommandot tilldela rollen service principal läsare alla prenumerationer som du har åtkomst. </br></br>
``azlog authorize <SubscriptionID>`` </br> till exempel </br>
``azlog authorize 0ee55555-0bc4-4a32-a4e8-c29980000000``

    >[!NOTE]
    Varningar kan visas om du kör kommandot auktorisera omedelbart efter kommandot createazureid. Det finns vissa fördröjning mellan när Azure AD-kontot skapas och när kontot är tillgängliga för användning. Om du vänta ungefär 60 sekunder när du har kört kommandot createazureid köra kommandot auktorisera bör du inte se dessa varningar.
