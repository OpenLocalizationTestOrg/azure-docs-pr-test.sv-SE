...
---
# <a name="azure-cosmos-db-create-a-firewall-using-hello-azure-cli"></a>Azure Cosmos DB: Skapa en brandvägg som använder hello Azure CLI
...
| [AZ cosmosdb uppdatering](https://docs.microsoft.com/cli/azure/cosmosdb#update) | Uppdaterar en Azure CosmosDB konto tooinclude brandväggsinställningar. |
