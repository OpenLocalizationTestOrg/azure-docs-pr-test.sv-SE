...
---
# <a name="get-an-azure-cosmos-db-connection-string-for-mongodb-apps-using-hello-azure-cli"></a>Hämta en Azure Cosmos DB-anslutningssträngen för MongoDB-appar som använder hello Azure CLI

Det här exemplet hämtar en Azure Cosmos DB-anslutningssträng för MongoDB-appar som använder hello Azure CLI. 
...
| [AZ cosmosdb lista--anslutningssträngar](https://docs.microsoft.com/cli/azure/cosmosdb#list-connection-strings) | Hämtar hello anslutningssträngen för hello-konto.|
