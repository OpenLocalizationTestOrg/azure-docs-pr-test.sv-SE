...
[!code-azurecli-interactive[huvudsakliga](../../../cli_scripts/cosmosdb/secure-cosmosdb-get-mongodb-connection-string/secure-cosmosdb-get-mongodb-connection-string.sh?highlight=36-39 "hämta Azure Cosmos-DB-anslutningssträngen för MongoDB-appar")]
...
| [AZ cosmosdb lista--anslutningssträngar](https://docs.microsoft.com/cli/azure/cosmosdb#list-connection-strings) | Hämtar anslutningssträngen för kontot.|
