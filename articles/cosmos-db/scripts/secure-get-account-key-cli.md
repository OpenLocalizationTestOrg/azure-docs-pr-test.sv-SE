...
---
# <a name="get-account-keys-for-azure-cosmos-db-using-hello-azure-cli"></a>Hämta nycklar för Azure Cosmos-databasen med hello Azure CLI
...
| [AZ cosmosdb lista nycklar](https://docs.microsoft.com/cli/azure/cosmosdb#list-keys) | Skapar en logisk server att värdar hello SQL-databas. |
