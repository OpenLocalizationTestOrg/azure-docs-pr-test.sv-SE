...
[!code-azurecli-interactive[huvudsakliga](../../../cli_scripts/cosmosdb/scale-cosmosdb-get-account-key/secure-cosmosdb-get-account-key.sh?highlight=22-25 "hämta Azure Cosmos DB nycklar")]
...
| [AZ cosmosdb lista nycklar](https://docs.microsoft.com/cli/azure/cosmosdb#list-keys) | Skapar en logisk server som är värd för SQL-databasen. |
