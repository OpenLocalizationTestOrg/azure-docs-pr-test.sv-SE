...
Den här artikeln innehåller en översikt över S1, S2 och S3 prestandanivåer och beskriver hur de samlingar som använder dessa prestandanivåer kommer att migreras till enskilda partitionssamlingar på 1 augusti 2017. När du har läst den här artikeln kommer du att kunna svara på följande frågor:
...
- [Kan jag ändra mellan S1, S2 och S3 prestandanivåer före den 1 augusti 2017?](#change-before)
...
Något, Cosmos DB hanterar du migreringen. Om du har en S1, S2 och S3 samling kommer aktuella samlingen att migreras till en enda partition samling på 31 juli 2017. 
...
## <a name="can-i-change-between-the-s1-s2-and-s3-performance-levels-before-august-1-2017"></a>Kan jag ändra mellan S1, S2 och S3 prestandanivåer före den 1 augusti 2017?

Endast befintliga konton med S1, S2 och S3 prestanda kommer att kunna ändra och ändra nivån prestandanivåer via portalen eller programmässigt. Med den 1 augusti 2017 kommer prestandanivåer S1, S2 och S3 inte längre tillgängliga. Om du ändrar från S1, S3 eller S3 till en enda partition samling, kan du återgå till prestandanivåer S1, S2 och S3.

<a name="when-migrated"></a>

## <a name="how-will-i-know-when-my-collection-has-migrated"></a>Hur vet jag om min samling har migrerats?

Migreringen sker på 31 juli 2017. Om du har en samling som använder S1 S2 eller S3 prestandanivåer, Cosmos-DB-teamet kommer att kontakta dig via e-post innan migreringen sker. När migreringen är klar på 1 augusti 2017 visar Azure-portalen att din samling använder standardprisnivån.
...
Du kan migrera från prestandanivåer S1, S2 och S3 till enskilda partitionssamlingar med Azure-portalen eller programmässigt. Du kan göra detta på egen hand före den 1 augusti att dra nytta av flexibla genomströmning-alternativen med enskilda partitionssamlingar eller kommer vi att migrera samlingar för dig på den 31 juli 2017.
