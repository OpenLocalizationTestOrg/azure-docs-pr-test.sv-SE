...
Du kan hämta och installera Azure Cosmos-DB-emulatorn från den [Microsoft Download Center](https://aka.ms/cosmosdb-emulator). 
...
När du har [Docker för Windows](https://www.docker.com/docker-windows) installerat kan du dra emulatorn avbildningen från Docker-hubben genom att köra följande kommando från dina Favoriter shell (cmd.exe, PowerShell, etc.).
...
## <a name="running-the-emulator-on-a-local-network"></a>Kör emulatorn i ett lokalt nätverk
...
## <a name="differences-between-the-azure-cosmos-db-emulator-and-azure-cosmos-db"></a>Skillnader mellan Azure Cosmos DB-emulatorn och Azure Cosmos DB 
