...
[Azure Cosmos-DB](introduction.md) är global och flera olika modeller databastjänsten från Microsoft för verksamhetskritiska program. Azure Cosmos-DB tillhandahåller [nyckelfärdig global distributionsplatsen](distribute-data-globally.md), [elastisk skalbarhet av dataflöden och lagringsutrymmen](partition-data.md) över hela världen, en siffra millisekunders latens vid 99th percentilen [fem väldefinierade konsekvensnivåer](consistency-levels.md), och garanteras hög tillgänglighet, som alla backas upp av [branschledande serviceavtal](https://azure.microsoft.com/support/legal/sla/cosmos-db/). Azure Cosmos DB [indexerar alla data automatiskt](http://www.vldb.org/pvldb/vol8/p1668-shukla.pdf) utan att du behöver bry dig om schema- eller indexhantering. Det stöder flera modeller och dokument, nyckelvärde graf och kolumndatamodeller.
...
- Elastisk skalning av lagring och dataflöde med mindre än 10 ms läsa svarstiderna och mindre än 15 ms på 99th percentil
...
Du kan kombinera snabb traversals med diagrammet databaser med graph-algoritmer som djup första sökning, breda första Sök och Dijkstras algoritmen att lösa problem i olika domäner som sociala nätverk innehåll hantering, geospatiala och rekommendationer.
...
* Justerbara konsekvensnivåer
 ...
 Välj fem väldefinierade konsekvensnivåer för bästa möjliga balans mellan konsekvens och prestanda. Azure Cosmos DB erbjuder fem olika konsekvensnivåer för frågor och läsåtgärder: stark, bunden utgång, session, enhetligt prefix och slutlig. Dessa detaljerade, väldefinierade konsekvensnivåerna kan du ljud kompromissa mellan konsekvens, tillgänglighet och svarstid. Läs mer om hur du [maximerar tillgänglighet och prestanda i DocumentDB med hjälp av konsekvensnivåer](consistency-levels.md).
...
Med hjälp av den [Azure Cosmos DB emulatorn](local-emulator.md), Använd Graph API för att utveckla och testa lokalt utan att skapa en Azure-prenumeration eller kostnader. När du är nöjd med hur programmet fungerar i emulatorn kan växla du till med ett Azure DB som Cosmos-konto i molnet.
...
* Internet of Things
 ...
 Med nätverks- och anslutningar mellan modelleras som ett diagram för IoT-enheter kan du skapa en bättre förståelse av status för enheterna och tillgångar och lära dig hur ändringar i en del av nätverket kan potentiellt påverkar en annan del.
...
* Lär dig mer om hur du [fråga diagram i Azure Cosmos-databasen med Gremlin](gremlin-support.md).
