...
Läs mer om hur du optimerar och felsöka Azure apps i [felsöka en webbapp i Azure App Service med Visual Studio](app-service-web/web-sites-dotnet-troubleshoot-visual-studio.md).
