...
1. Konfigurera mobilappsserverdelen för inloggning Twitter genom att följa den [konfigurera App Service för Twitter inloggningen](app-service-mobile-how-to-configure-twitter-authentication.md) kursen.
...
1. Konfigurera mobilappsserverdelen för Google-inloggning genom att följa den [konfigurera App Service för Google inloggningen](app-service-mobile-how-to-configure-google-authentication.md) kursen.
