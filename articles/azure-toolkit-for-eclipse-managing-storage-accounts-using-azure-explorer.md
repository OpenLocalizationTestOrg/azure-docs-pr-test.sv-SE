...
---
# <a name="manage-storage-accounts-by-using-the-azure-explorer-for-eclipse"></a>Hantera storage-konton med hjälp av Azure-Explorer för Eclipse

Azure Explorer, som är en del av Azure-verktygen för Eclipse ger Java-utvecklare med en enkel att använda lösning för hantering av lagringskonton i Azure kontot från i Eclipse integrated development environment (IDE).
...
3. I den **skapa Lagringskonto** dialogrutan anger du följande alternativ:
   ...
   * **Region**: Anger platsen där ditt lagringskonto skapas (till exempel ”West US”).
...
4. När du har angett alla föregående alternativ, klickar du på **skapa**.
...
1. I den **Azure Explorer** Högerklicka på det lagringskonto där du vill skapa en behållare och klicka sedan på **skapa blob-behållaren**.
...
1. I den **Azure Explorer** visa, högerklicka på lagringsbehållare för och klicka sedan på **ta bort**.

   ![Ta bort lagring behållaren kommando][DC01]

2. Klicka på i bekräftelsefönstret **OK**.
...
1. I den **Azure Explorer** visa, högerklicka på lagringskontot och klicka sedan på **ta bort**.
