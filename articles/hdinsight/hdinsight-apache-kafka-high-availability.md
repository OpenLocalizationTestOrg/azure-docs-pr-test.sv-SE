...
Varje Azure-region har ett visst antal feldomäner. En lista med domäner och antalet feldomäner de innehåller finns i dokumentationen av [tillgänglighetsuppsättningar](../virtual-machines/linux/regions-and-availability.md#availability-sets).
...
I dokumentet [Start with Kafka on HDInsight](hdinsight-apache-kafka-get-started.md) (Kom igång med Kafka i HDInsight) ges ett exempel på hur du skapar ämnen och ställer in replikeringsfaktorn.
