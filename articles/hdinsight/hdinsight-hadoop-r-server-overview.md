...
I dessa fall kan ytterligare paket installeras med en skriptåtgärd när du har skapat klustret. Mer information finns i [skapar ett HDInsight-kluster med R Server](hdinsight-hadoop-r-server-get-started.md).   
