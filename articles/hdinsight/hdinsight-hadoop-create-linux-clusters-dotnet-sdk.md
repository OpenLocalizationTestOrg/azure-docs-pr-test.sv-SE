...
---
# <a name="create-linux-based-clusters-in-hdinsight-using-hello-net-sdk"></a>Skapa Linux-baserade kluster i HDInsight med hello .NET SDK

[!INCLUDE [selector](../../includes/hdinsight-create-linux-cluster-selector.md)]


Lär dig hur toocreate ett Hadoop-kluster i Azure HDInsight med hello .NET SDK.

> [!IMPORTANT]
> hello stegen i det här dokumentet kan du skapa ett kluster med en arbetsnoden. Om du planerar att mer än 32 arbetarnoder i klustret har skapats eller genom att skala hello klustret när den har skapats, måste tooselect en huvudnod storlek med minst 8 kärnor och 14GB RAM-minne.
>
...
3. Från hello **verktyg** -menyn klickar du på **NuGet Package Manager**, och klicka sedan på **Pakethanterarkonsolen**.
4. Kör följande kommando i hello konsolen tooinstall hello paket hello:
    ...
    Dessa kommandon Lägg till .NET-bibliotek och referenser toothem toohello aktuella Visual Studio-projekt.
5. Dubbelklicka på Solution Explorer **Program.cs** tooopen, klistra in följande kod hello och ange värden för hello variabler:
...
6. Ersätt hello klassen medlemsvärden.
7. Tryck på **F5** toorun hello program. Konsolfönstret öppnar och visar hello statusinformation hello-programmet. Du är begärd tooenter dina Azure-autentiseringsuppgifter. Det kan ta flera minuter toocreate ett HDInsight-kluster normalt cirka 15.

## <a name="use-bootstrap"></a>Använd starttjänsten

Med bootstrap kan konfigurera du ytterligare inställningar under hello klustret skapande.  Mer information finns i [anpassa HDInsight-kluster med Bootstrap](hdinsight-hadoop-customize-cluster-bootstrap.md).

Ändra hello provet i [Skapa kluster](#create-clusters) tooconfigure en Hive-inställning:
...
Ändra hello provet i [Skapa kluster](#create-clusters) toocall en skriptåtgärd tooinstall R:
