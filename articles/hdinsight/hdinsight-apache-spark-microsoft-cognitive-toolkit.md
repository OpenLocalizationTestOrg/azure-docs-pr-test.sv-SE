...
3. Från Jupyter-anteckningsbok klickar du på **överför** i övre högra hörn och gå sedan till den plats där du har klonat GitHub-lagringsplatsen.
    ...
    ![Överför Jupyter-anteckningsbok till Azure HDInsight Spark-kluster](./media/hdinsight-apache-spark-microsoft-cognitive-toolkit/hdinsight-microsoft-cognitive-toolkit-load-jupyter-notebook.png "överför Jupyter-anteckningsbok till Azure HDInsight Spark-kluster")
