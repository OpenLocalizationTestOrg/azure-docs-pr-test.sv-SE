...
#### [Använd hello Hive-vy](hdinsight-hadoop-use-hive-ambari-view.md)
...
#### [Använd hello HDInsight tools för Visual Studio](hdinsight-hadoop-use-hive-visual-studio.md)
#### [Använda Fjärrskrivbord](hdinsight-hadoop-use-hive-remote-desktop.md)
#### [Använd hello frågan konsolen](hdinsight-hadoop-use-hive-query-console.md)
...
### [Kör hello MapReduce-exempel](hdinsight-hadoop-run-samples-linux.md)
...
#### [Använd hello .NET SDK](hdinsight-hadoop-use-pig-dotnet-sdk.md)
...
#### [Skriv tooData Lake Store](hdinsight-storm-write-data-lake-store.md)
...
### [Använda HDInsight Tools toocreate Spark appar](hdinsight-apache-spark-eclipse-tool-plugin.md)
### [Använda HDInsight Tools toodebug Spark appar via fjärranslutning via SSH](hdinsight-apache-spark-intellij-tool-debug-remotely-through-ssh.md)
...
### [Ansluta Excel tooHadoop](hdinsight-connect-excel-hive-odbc-driver.md)
### [Ansluta med hello Hive JDBC-drivrutinen](hdinsight-connect-hive-jdbc-driver.md)
...
### [Ansluta HDInsight tooyour lokalt nätverk](connect-on-premises-network.md)
...
#### [Använda REST tooinstall appar](https://msdn.microsoft.com/library/mt706515.aspx)
#### [Publicera HDInsight appar tooAzure Marketplace](hdinsight-apps-publish-applications.md)
## Skydda
### [Använda SSH med HDInsight](hdinsight-hadoop-linux-use-ssh-unix.md)
### [Använda SSH-tunnel](hdinsight-linux-ambari-ssh-tunnel.md)
### [Begränsa åtkomst toodata](hdinsight-storage-sharedaccesssignature-permissions.md)
## Hantera
...
#### [Använder cURL och hello Azure REST API](hdinsight-hadoop-create-linux-clusters-curl-rest.md)
#### [Använd hello .NET SDK](hdinsight-hadoop-create-linux-clusters-dotnet-sdk.md)
#### [Använd hello Azure CLI](hdinsight-hadoop-create-linux-clusters-azure-cli.md)
#### [Använd hello Azure-portalen](hdinsight-hadoop-create-linux-clusters-portal.md)
...
#### [Använd hello Azure CLI](hdinsight-administer-use-command-line.md)
### [Hantera kluster med hello Ambari-webbgränssnittet](hdinsight-hadoop-manage-ambari.md)
...
### [Migrera tooResource Manager utvecklingsverktyg](hdinsight-hadoop-development-using-azure-resource-manager.md)
### [Tillgänglighet och tillförlitlighet](hdinsight-high-availability-linux.md)
### [HDInsight-kluster toonewer uppgraderingsversion](hdinsight-upgrade-cluster.md)
...
#### [Använda Ambari Views toodebug Tez jobb](hdinsight-debug-ambari-tez-view.md)
...
# Relaterat
## Windows-kluster
### [Migrera Windows-kluster tooLinux kluster](hdinsight-migrate-from-windows-to-linux.md)
### [Migrera .NET lösningar tooLinux kluster](hdinsight-hadoop-migrate-dotnet-to-linux.md)
### [Köra MapReduce-exempel i Hadoop](hdinsight-run-samples.md)
### [Använda Solr i kluster](hdinsight-hadoop-solr-install-linux.md)
### [Använd Giraph tooprocess storskaliga diagram](hdinsight-hadoop-giraph-install.md)
...
### [Använd Maven toobuild Java-program](hdinsight-hbase-build-java-maven.md)
### [Använd hello Tez UI toodebug Tez jobb](hdinsight-debug-tez-ui.md)
...
### [Övervaka kluster med hello Ambari API](hdinsight-monitor-use-ambari-api.md)

# Resurser
## [Azure-översikt](https://azure.microsoft.com/roadmap/?category=intelligence-analytics)
## [Få hjälp på hello-forumet](https://social.msdn.microsoft.com/forums/azure/en-US/home?forum=hdinsight)
