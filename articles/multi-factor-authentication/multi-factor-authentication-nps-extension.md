...
4. PowerShell frågar efter klient-ID. Använd katalog-ID-GUID som du kopierade från Azure-portalen i avsnittet förutsättningar.
5. Logga in på Azure AD som administratör.
