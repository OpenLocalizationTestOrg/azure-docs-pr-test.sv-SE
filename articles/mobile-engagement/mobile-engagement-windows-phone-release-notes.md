...
En del av hello *MicrosoftAzure.MobileEngagement* Nuget-paketet **v3.4.0**
...
En del av hello *MicrosoftAzure.MobileEngagement* Nuget-paketet **v3.3.0**

* Anpassade scheman, ms-appx och ms-appdata som är tillgängliga på åtgärd-URL: er.
* Stabilitetsförbättringar.

## <a name="310-11202015"></a>3.1.0 (11/20/2015)
En del av hello *MicrosoftAzure.MobileEngagement* Nuget-paketet **v3.2.0**
