...
# Kom igång
## [Skapa en Linux VM med hello-portalen](createportal.md)
...
### [Övervaka virtuella datorer med hello diagnostiska VM-tillägget](../diagnostic-extension.md)
### [Övervaka virtuella datorer med v2.x av hello diagnostiska VM-tillägget](diagnostic-extension-v2.md)
...
### [Skapa en Docker-värd med hello CLI](cli-use-docker.md)
### [Skapa en Docker-värd med hjälp av hello portal](portal-use-docker.md)
### [Hur toouse Docker med Swarm](../../virtual-machines-linux-docker-swarm.md)
...
## Nätverk
### [Öppna portar tooyour VM](setup-endpoints.md)
...
#### [Med hjälp av belastningsutjämnade uppsättningar tooclusterize MySQL](mysql-cluster.md)
...
### [RDMA klustret toorun MPI program](rdma-cluster.md)
### [Hur toouse hello Azure slavserver plugin-program med Hudson CI](../../virtual-machines-azure-slave-plugin-for-hudson.md)
### HPC Pack
...
### [Anslut virtuell hårddisk tootroubleshooting VM](troubleshoot-recovery-disks-portal.md)
