...
Det här skriptet skapar en virtuell dator med Docker aktiverad och startar en NGINX-behållare. När du har kört hello skript du komma åt hello NGINX-webbservern via hello FQDN för hello virtuella Azure-datorn. 
...
| [Ange AzureRmVMExtension](/powershell/module/azurerm.compute/set-azurermvmextension) | Lägg till en VM-tillägget toohello virtuell dator. I det här exemplet hello Docker-tillägget har använt tooconfigure Docker och kör en Docker NGINX-behållare. |
