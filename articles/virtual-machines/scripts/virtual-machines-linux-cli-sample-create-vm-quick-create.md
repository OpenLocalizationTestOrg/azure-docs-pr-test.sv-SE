...
Det här skriptet skapar en virtuell dator i Azure med ett Ubuntu-operativsystem och relaterade nätverksresurser. Du kan komma åt hello virtuella datorn när du har kört hello skript via SSH.
