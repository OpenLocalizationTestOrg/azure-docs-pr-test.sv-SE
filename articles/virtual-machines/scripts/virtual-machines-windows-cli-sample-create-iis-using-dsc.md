...
[!code-azurecli-interactive[huvudsakliga](../../../cli_scripts/virtual-machine/create-windows-iis-using-dsc/create-windows-iis-using-dsc.sh "snabbt skapa virtuell dator")]
...
| [AZ vm-tillägget uppsättningen](https://docs.microsoft.com/cli/azure/vm#create) | Lägg till tillägget för anpassat skript till den virtuella datorn som anropar ett skript för att installera IIS. |
