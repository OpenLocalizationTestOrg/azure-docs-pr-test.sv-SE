...
Det här skriptet skapar en virtuell dator i Azure, hello Operations Management Suite (OMS) agent installeras och registrerar hello system med en OMS-arbetsyta. När hello skriptet har körts visas hello virtuell dator i hello OMS-konsolen. Du måste också tooupdate hello OMS arbetsytan ID och arbetsytenyckel.
...
| [Ange AzureRmVMExtension](/powershell/module/azurerm.compute/set-azurermvmextension) | Lägg till en VM-tillägget toohello virtuell dator. I det här fallet är används tooinstall hello OMS-agent hello Operations Management Suite-agenten tillägget och registrera hello VM i en OMS-arbetsyta. |
