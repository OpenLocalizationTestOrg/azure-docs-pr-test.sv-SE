...
---
# <a name="azure-windows-vm-extension-configuration-samples"></a>Konfigurationsexempel för virtuella Azure Windows-datortillägg
> [!div class="op_single_selector"]
> * [PowerShell - mall](extensions-configuration-samples.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)
> * [CLI - mall](../linux/extensions-configuration-samples.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
> 
> 

<br>

Den här artikeln innehåller exempel på konfiguration för att konfigurera Azure VM-tillägg för virtuella Windows-datorer.

toolearn mer om dessa tillägg finns [översikt över Azure VM-tillägg.](extensions-features.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)

toolearn mer information om redigering av tillägget mallar finns [mallar för redigering av tillägget.](extensions-authoring-templates.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)

Den här artikeln innehåller förväntade konfigurationsvärden för några av hello Windows-tillägg.

## <a name="sample-template-snippet-for-vm-extensions-with-iaas-vms"></a>Exempel mallen fragment för VM-tillägg med IaaS-VM.
hello mallen fragment för att distribuera tillägg ser ut som följande:
...
## <a name="sample-template-snippet-for-vm-extensions-with-vm-scale-sets"></a>Exempel mallen fragment för VM-tillägg med Skalningsuppsättningar.
    {
...
Innan du distribuerar hello tillägget Kontrollera hello senaste tilläggsversionen och ersätta hello ”typeHandlerVersion” med hello aktuella senaste versionen.

Resten av hello artikeln ger exempel konfigurationer för Windows VM-tillägg.

Innan du distribuerar hello tillägget Kontrollera hello senaste tilläggsversionen och ersätta hello ”typeHandlerVersion” med hello aktuella senaste versionen.

### <a name="customscript-extension-14"></a>CustomScript-tillägg 1.4.
      {
...
#### <a name="parameter-description"></a>Parameterbeskrivning:
* fileUris: kommatecken avgränsade lista över URL: er för hello-filer som ska hämtas hello VM av hello tillägg. Inga filer laddas om inget anges. Om hello filer i Azure Storage, hello fileURLs kan markeras privata och hello correspoding storageAccountName och storageAccountKey kan skickas som privat parametrar tooaccess dessa filer.
* commandToExecute: [obligatorisk Parameter]: Detta är hello-kommando som kommer att utföras av hello tillägg.
* storageAccountName: [valfri Parameter]: Lagringskontonamnet för att komma åt hello fileURLs om de är markerade som privat.
* storageAccountKey: [valfri Parameter]: Lagringskontonyckel för att komma åt hello fileURLs om de är markerade som privat.

### <a name="customscript-extension-17"></a>CustomScript-tillägg 1.7.
Parameterbeskrivning finns tooCustomScript version 1.4. Version 1.7 introducerar stöd för att skicka skript parameters(commandToExecute) som protectedSettings, i så fall kommer de att krypteras innan det skickas. 'commandToExecute-parameter kan anges antingen i inställningar eller protectedSettings men inte båda.
...
### <a name="vmaccess-extension"></a>VMAccess-tillägget.
      {
          "publisher": "Microsoft.Compute",
          "type": "VMAccessAgent",
...
### <a name="dsc-extension"></a>DSC-tillägg.
      {
...
### <a name="trend-micro-deep-security-agent"></a>Trend Micro djup Security Agent.
      {
...
### <a name="vormertric-transparent-encryption-agent"></a>Vormertric Transparent kryptering Agent.
            {
              "publisher": "Vormetric",
...
### <a name="puppet-enterprise-agent"></a>Puppet Enterprise-agenten.
            {
...
### <a name="microsoft-monitoring-agent-for-azure-operational-insights"></a>Microsoft Monitoring Agent för åtgärdsinformation i Azure
            {
...
### <a name="azure-iaas-antimalware"></a>Azure IaaS program mot skadlig kod
          {
...
### <a name="eset-file-security"></a>TERSTÄLL filsäkerhet
          {
            "publisher": "ESET",
            "type": "FileSecurity",
            "typeHandlerVersion": "6.0",
...
### <a name="confer-advanced-threat-prevention-and-incident-response-for-azure"></a>Ge Advanced Threat förebyggande och incidenter för Azure
          {
            "publisher": "Confer",
            "type": "ConferForAzure",
            "typeHandlerVersion": "1.0",
...
### <a name="barracuda-vpn-connectivity-agent-for-microsoft-azure"></a>Barracuda VPN-anslutningen Agent för Microsoft Azure
          {
...
### <a name="alert-logic-log-manager"></a>Aviseringshanterare för logik-logg
          {
...
Mer information om hur tooconfigure diagnostik finns [Azure Diagnostics tillägg](extensions-diagnostics-template.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)
...
### <a name="octopus-deploy-tentacle-agent"></a>Bläckfisk distribuera i förband Agent

Mer information om hur tooconfigure hello bläckfisk distribuera i förband på Azure finns hello [bläckfisk dokumentationen](https://octopus.com/docs/installation/installing-tentacles/azure-virtual-machines).
...
Ersätt hello versionsnummer med hello senaste versionsnumret i hello exemplen ovan.

Här är ett exempel på en fullständig mall för virtuell dator med tillägget för anpassat skript.
