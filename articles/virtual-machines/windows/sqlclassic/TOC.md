...
# Kom igång
## [Etablera en virtuell dator i hello Azure-portalen](../sql/virtual-machines-windows-portal-sql-server-provision.md?toc=%2fazure%2fvirtual-machines%2fwindows%2fsqlclassic%2ftoc.json)
## [Etablera en virtuell dator med Azure PowerShell](virtual-machines-windows-classic-ps-sql-create.md)
## [Ansluta tooa VM](virtual-machines-windows-classic-sql-connect.md)
...
### [Konfigurera Always On-tillgänglighetsgrupp i hello klassiska portalen](virtual-machines-windows-classic-portal-sql-alwayson-availability-groups.md)
...
### [Utöka lokala tillgänglighet grupp tooAzure](virtual-machines-windows-classic-sql-onprem-availability.md)
## Hantera
### [Använd hello tillägg för SQL Server IaaS Agent](virtual-machines-windows-classic-sql-server-agent-extension.md)
...
### [Använda PowerShell toocreate virtuella Azure-datorn med en rapportserver](virtual-machines-windows-classic-ps-sql-report.md)
