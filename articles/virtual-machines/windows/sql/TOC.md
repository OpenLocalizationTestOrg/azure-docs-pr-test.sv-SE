...
# Kom igång
## [Etablera en virtuell dator i hello Azure-portalen](virtual-machines-windows-portal-sql-server-provision.md)
## [Etablera en virtuell dator med Azure PowerShell](virtual-machines-windows-ps-sql-create.md)
## [Ansluta tooa VM](virtual-machines-windows-sql-connect.md)
...
## Hantera
### [Använd hello tillägg för SQL Server IaaS Agent](virtual-machines-windows-sql-server-agent-extension.md)
