...
I September 2016 Microsoft släppt en funktion där du kan hantera flera virtuella IP-adresser med hjälp av en [Azure intern belastningsutjämnare][load-balancer-multivip-overview]. Den här funktionen finns redan i hello Azure extern belastningsutjämnare.
...
> [!NOTE]
> Den här funktionen är endast tillgänglig i hello Azure Resource Manager-distributionsmodellen.
...
4. [Installera hello-databasinstans][sap-ha-guide-9.2].  
 I det här steget installerar om du DBMS på en dedikerad WSFC-klustret.

5. [Installera hello andra klusternod][sap-ha-guide-9.3].  
