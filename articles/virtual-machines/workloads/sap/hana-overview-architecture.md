...
Specifika konfigurationer som valts är beroende av arbetsbelastning, CPU-resurser och önskade minne. Det är möjligt för OLTP-arbetsbelastning utnyttja SKU: er som är optimerade för OLAP-arbetsbelastning. 
...
Typen I klassen SKU: er, volymen Start LUN som är lagrad på, är krypterad. Vid typ II klass av SKU: er av HANA stora instanser måste du kryptera Start LUN med OS-metoder. 
