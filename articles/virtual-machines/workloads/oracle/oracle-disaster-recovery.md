...
## <a name="goals"></a>Mål
- Utforma hello topologi och konfiguration som uppfyller dina krav för disaster recovery (DR).

## <a name="scenario-1-primary-and-dr-sites-on-azure"></a>Scenario 1: Den primära servern och DR platser på Azure

En kund har en Oracle databasen set upp på hello primär plats. En DR-plats finns i en annan region. hello kunden använder Oracle Data Guard för snabb återställning mellan dessa platser. hello primär plats har också en sekundär databas för rapportering och andra ändamål. 

### <a name="topology"></a>topologi

Här följer en sammanfattning av hello installationsprogram för Azure:
...
- Två programtjänster, en primär och en på hello DR-plats
- En *tillgänglighetsuppsättning* som används för databasen och programmet hello primär plats
- En jumpbox på varje plats, vilket begränsar åtkomst toohello privata nätverk och kan bara logga in som administratör
...
En kund har en lokal Oracle database-installation (primär plats). En DR-plats finns på Azure. Oracle Data Guard används för snabb återställning mellan dessa platser. hello primär plats har också en sekundär databas för rapportering och andra ändamål. 

Det finns två tillvägagångssätt för den här installationen.

### <a name="approach-1-direct-connections-between-on-premises-and-azure-requiring-open-tcp-ports-on-hello-firewall"></a>Metod 1: Direkta anslutningar mellan lokala och Azure, som kräver öppna TCP-portar i brandväggen hello 

Vi rekommenderar inte direkta anslutningar eftersom de exponera hello TCP-portar toohello utanför världen.

#### <a name="topology"></a>topologi

Nedan följer en sammanfattning av hello installationsprogram för Azure:

- En DR-plats 
- Ett virtuellt nätverk
- En Oracle-databas med Data Guard (aktiv)
- Ett program-tjänsten på hello DR-plats
- En jumpbox som begränsar åtkomst toohello privata nätverk och kan bara logga in som administratör
- En jumpbox programtjänsten, databas och VPN-gateway på separata undernät
- NSG tillämpas på programmet och databasen undernät
- En NSG principregeln/tooallow inkommande TCP-port 1521 (eller en användardefinierad port)
- En NSG principregeln/toorestrict endast hello IP-adress/adresser lokalt (DB eller program) tooaccess hello virtuellt nätverk
...
Plats-till-plats VPN är en bättre metod. Mer information om hur du konfigurerar en VPN-anslutning finns [skapa ett virtuellt nätverk med en plats-till-plats VPN-anslutning med hjälp av CLI](https://docs.microsoft.com/en-us/azure/vpn-gateway/vpn-gateway-howto-site-to-site-resource-manager-cli).
