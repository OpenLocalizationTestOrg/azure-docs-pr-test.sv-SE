...
---
# <a name="step-4-plan-networking-for-vmware-tooazure-replication"></a>Steg 4: Planera nätverk för VMware tooAzure replikering

Den här artikeln sammanfattar nätverket några saker att tänka på när du replikera lokala virtuella VMware-datorer tooAzure med hello [Azure Site Recovery](site-recovery-overview.md) service.
...
## <a name="connect-tooreplica-vms"></a>Ansluta tooreplica virtuella datorer
