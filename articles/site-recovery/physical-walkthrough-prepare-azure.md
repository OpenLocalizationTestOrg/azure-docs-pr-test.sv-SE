...
---
# <a name="step-5-prepare-azure-resources-for-physical-server-replication-tooazure"></a>Steg 5: Förbered Azure-resurser för fysisk server replication tooAzure


Använd hello instruktioner i den här artikeln tooprepare Azure resurser så att du kan replikera lokala servrar tooAzure med hello [Azure Site Recovery](site-recovery-overview.md) service.
...
Kontrollera att du har läst hello [krav](physical-walkthrough-prerequisites.md).
...
- Site Recovery replikerar lokala servrar tooAzure lagring. Virtuella Azure-datorer skapas från hello lagring efter redundansväxlingen.
