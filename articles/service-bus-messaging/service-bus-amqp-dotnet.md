...
Där `[namespace]` och `SharedAccessKey` hämtas från den [Azure-portalen] [ Azure portal] när du skapar en Service Bus-namnrymd. Mer information finns i [skapa ett namnområde för Service Bus med hjälp av Azure portal][Create a Service Bus namespace using the Azure portal].
