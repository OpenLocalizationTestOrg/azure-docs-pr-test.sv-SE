...
## <a name="use-yoeman-to-package-and-deploy-an-existing-executable-on-linux"></a>Använda Yoeman att paketera och distribuera en befintlig körbar fil på Linux
