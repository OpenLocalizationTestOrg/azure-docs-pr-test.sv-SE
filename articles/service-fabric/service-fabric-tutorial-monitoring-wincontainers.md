...
* Distribuera den med hjälp av PowerShell så här uppgraderar du klustret med [distribuerar mallen](https://docs.microsoft.com/azure/service-fabric/service-fabric-cluster-creation-via-arm). Azure Resource Manager inser att resursen finns, så görs det som en uppgradering.
