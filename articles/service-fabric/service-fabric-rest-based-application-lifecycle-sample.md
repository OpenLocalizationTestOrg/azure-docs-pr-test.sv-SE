...
Det här exemplet visar hello Service Fabric application livscykel via REST API-anrop. Mer information om hello Service Fabric application lifecycle finns [Service Fabric application livscykel](service-fabric-application-lifecycle.md).

Det här exemplet utför hello följande:

* Tillhandahåller hello **WordCount 1.0.0** exempel från hello WordCount programpaket i hello avbildningsarkivet.
* Visar hello lista över programtyper, inklusive WordCount 1.0.0.
* Skapar hello WordCount program som **fabric: / WordCount**.
* Visar hello lista över program som innehåller fabric: / WordCount version 1.0.0.
* Tillhandahåller hello 1.1.0 version hello WordCount-exemplet från hello **WordCountUpgrade** programpaket i hello avbildningsarkivet.
* Visar hello listan över programtyper, som innehåller både WordCount 1.0.0 och **WordCount 1.1.0**.
* Uppgraderar hello WordCount programmet tooversion 1.1.0.
* Visar hello lista över program som innehåller WordCount version 1.1.0, men innehåller inte längre WordCount version 1.0.0.
* Tar bort hello WordCount program.
* Visar hello lista över program som inte längre innehåller fabric: / WordCount.
* Avetablerar hello 1.1.0 version hello WordCount-exemplet.
* Visar hello listan över programtyper, vilket inkluderar WordCount 1.0.0, men innehåller inte längre WordCount 1.1.0.
* Avetablerar hello 1.0.0 version hello WordCount-exemplet.
* Visar hello listan över programtyper, som inte längre innehåller WordCount.

## <a name="prerequisites"></a>Krav
Det här exemplet använder hello [WordCount-exemplet](http://aka.ms/servicefabricsamples) (hittas i hello **komma igång** exempel). Hej WordCount-exemplet måste skapas först och sedan två programpaket måste vara kopierade toohello avbildningsarkivet.

| Mapp | Beskrivning |
| --- | --- |
| WordCount |Hej WordCount exempelprogrammet. Hej **ApplicationManifest.xml** filen innehåller **ApplicationTypeVersion = ”1.0.0”**. |
| WordCountUpgrade |Hej WordCount exempelprogrammet. Hej ApplicationManifest.xml filen måste ändras för**ApplicationTypeVersion = ”1.1.0”** tooallow hello programmet uppgradera toooccur. |

toocreate hello programpaket och kopiera dem toohello avbildningsarkivet kan ta hello följande steg:

1. Kopiera **C:\ServiceFabricSamples\Services\WordCount\WordCount\pkg\Debug** för**C:\Temp\WordCount**. Detta skapar hello WordCount-programpaket.
2. Kopiera C:\Temp\WordCount för**C:\Temp\WordCountUpgrade**. Detta skapar hello **WordCountUpgrade programmet** paketet.
3. Öppna **C:\Temp\WordCountUpgrade\ApplicationManifest.xml** i en textredigerare.
4. I hello **ApplicationManifest** element, ändra hello **ApplicationTypeVersion** attribut för**”1.1.0”**.  Detta uppdaterar hello programmet hello versionsnummer.
5. Spara hello ändras ApplicationManifest.xml.
6. Kör följande PowerShell-skriptet som administratör hello toocopy hello program toohello avbildningsarkivet:
...
När hello PowerShell-skriptet har slutförts visas är det här programmet redo toorun.

## <a name="example"></a>Exempel
hello som följande exempel visar hello Service Fabric application livscykel.
