...
![Skärmbild av start-kort som visar ”distribuera Service Fabric-kluster”. ][Notifications]
...
Var och en av nodetypes får du ange i klustret resultaten i en virtuell dator Skaluppsättning komma installation. Se [fjärranslutning till en Virtual Machine Scale Set] [ remote-connect-to-a-vm-scale-set] mer information.
