...
Detta är det sista steget i den här genomgången [utveckla en förutsägelseanalys i Azure Machine Learning](machine-learning-walkthrough-develop-predictive-solution.md)
...
Mer information om hur du använder app webbmallar finns [använda en Azure Machine Learning webbtjänst med en mall för app](machine-learning-consume-web-service-with-web-app-template.md).
...
Du hittar information i [använda en Azure Machine Learning-webbtjänst](machine-learning-consume-web-services.md).
