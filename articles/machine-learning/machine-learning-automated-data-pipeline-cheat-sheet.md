...
* En översikt över Microsoft Azure Machine Learning, se [introduktion till maskininlärning på Microsoft Azure](machine-learning-what-is-machine-learning.md).
* En förklaring av hur du distribuerar en bedömningsprofil webbtjänst finns [distribuera en Azure Machine Learning-webbtjänst](machine-learning-publish-a-machine-learning-web-service.md).
* En beskrivning av hur du använder en bedömningsprofil webbtjänst finns [använda en Azure Machine Learning-webbtjänst](machine-learning-consume-web-services.md).
