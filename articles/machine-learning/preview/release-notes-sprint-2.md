...
>Här är hur du kan [hittar du versionsnumret](https://docs.microsoft.com/azure/machine-learning/preview/known-issues-and-troubleshooting-guide).
...
- [Stöd för SQL Server och SQL Azure DB som en datakälla](https://docs.microsoft.com/azure/machine-learning/preview/data-prep-appendix2-supported-data-sources#types) 
...
Mer information om hur du skapar beräkning mål finns [konfigurerar Azure Machine Learning experiment Service](https://docs.microsoft.com/azure/machine-learning/preview/experimentation-service-configuration)
