...
Med den [Azure Machine Learning-webbtjänst](https://docs.microsoft.com/azure/machine-learning/preview/model-management-service-deploy), ett externt program synkront kommunicerar med en förutsägelsemodell genom att göra HTTP POST-anrop till tjänsten URL-Adressen. Om du vill göra ett webbtjänstanrop måste klientprogrammet ange API-nyckeln som skapas när du distribuerar en förutsägelse och placera data för begäran i begärandetexten POST.
