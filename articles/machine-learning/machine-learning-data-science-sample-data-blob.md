...
1. Hämta hello data från Azure blob storage med hjälp av hello blob-tjänsten från följande exempelkod för Python hello: 
...
2. Läsa data i en Pandas data-ram från hello-fil som hämtas ovan.
...
3. Ned-sample hello data med hjälp av hello `numpy`'s `random.choice` på följande sätt:
...
Nu kan du arbeta med hello ovanför data ram med hello 1 procent exempel för vidare undersökning och funktionen generation.

## <a name="heading"></a>Överföra data och läsa in den i Azure Machine Learning
Du kan använda följande exempeldata kod toodown sampel hello hello och använda dem direkt i Azure Machine Learning:

1. Skriva hello ram tooa lokala datafilen
   
        dataframe.to_csv(os.path.join(os.getcwd(),LOCALFILENAME), sep='\t', encoding='utf-8', index=False)

2. Överför hello lokal fil tooan Azure blob med hello följande exempelkod:
...
3. Läsa hello data från hello Azure blob med hjälp av Azure Machine Learning [importera Data](https://msdn.microsoft.com/library/azure/4e1b0fe6-aded-4b3f-a36f-39b8862b9004/) enligt hello bilden nedan:
