...
Den här tjänsten accepterar 4 argument och beräknar hello ARIMA prognoser.
...
Det finns flera olika sätt att konsumera hello service automatiskt (en exempelapp är [här](http://microsoftazuremachinelearning.azurewebsites.net/ArimaForecasting.aspx)).
