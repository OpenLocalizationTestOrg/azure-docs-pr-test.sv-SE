...
En slutpunkt till slutpunkt genomgången exempel med hjälp av Cortana Analytics Process med en offentlig dataset finns [Cortana Analytics processen i praktiken: använder SQL Server](machine-learning-data-science-process-sql-walkthrough.md).
