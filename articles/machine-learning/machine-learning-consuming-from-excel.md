...
Om du använder Excel 2013 (eller senare) eller Excel Online, så vi rekommenderar att du använder Excel [Excel-tillägg](machine-learning-excel-add-in-for-web-services.md).

[!INCLUDE [machine-learning-free-trial](../../includes/machine-learning-free-trial.md)]

## <a name="steps"></a>Steg
Publicera en webbtjänst. [Den här sidan](machine-learning-walkthrough-5-publish-web-service.md) förklarar hur du gör. Funktionen Excel-arbetsboken stöds för närvarande endast för begäranden/svar-tjänsterna som har ett enda utflöde (det vill säga en enda bedömningsprofil etikett). 
