...
Lyckligtvis vi kan göra detta med hjälp av den [Azure Machine Learning API omtränings](machine-learning-retrain-models-programmatically.md) och automatisera aktiviteten med [Azure Machine Learning PowerShell](machine-learning-powershell-module.md).
