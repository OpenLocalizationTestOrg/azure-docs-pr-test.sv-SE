...
Över hello Azure-plattformen, levererar vi tillsammans övervakningsdata i en enda plats med hello Azure-Monitor pipeline, men praktiskt taget bekräftar att idag inga övervakningsdata är tillgängliga i denna pipeline ännu. I den här artikeln ska vi sammanfattar hello olika sätt som du kan komma åt övervakningsdata från Azure-tjänster.
...
| Apptjänst loggar | Händelser | App Services | <ul><li>**Fil-, tabell- eller blob storage:** [Web appdiagnostik](../app-service-web/web-sites-enable-diagnostic-log.md)</li></ul> |
...
- Lär dig mer om [hello Azure-aktivitetsloggen](monitoring-overview-activity-logs.md)
