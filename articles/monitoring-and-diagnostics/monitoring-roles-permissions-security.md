...
* Sök logganalys (OMS) arbetsytan data inklusive användningsdata för arbetsytan.
* Visa hanteringsgrupper för logganalys (OMS).
* Hämta Sök schemat logganalys (OMS).
* Lista över logganalys (OMS) intelligence Pack.
* Hämta och köra logganalys (OMS) sparade sökningar.
* Hämta lagringskonfiguration logganalys (OMS).
...
* Skapa och ta bort konfigurationen av logganalys (OMS).
