...
Det här exempelskriptet CLI skalar en Azure-databas för PostgreSQL servernivå tooa olika prestanda när du frågar hello mått. 
...
I det här exempelskriptet ändra hello markerade rader toocustomize hello admin användarnamn och lösenord. Ersätt hello prenumerations-id som används i hello az övervakaren kommandon med din egen prenumerations-id.[!code-azurecli-interactive[main](../../../cli_scripts/postgresql/scale-postgresql-server/scale-postgresql-server.sh?highlight=15-16 "Create and scale Azure Database for PostgreSQL.")]
