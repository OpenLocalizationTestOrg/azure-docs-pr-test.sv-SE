...
Spåra telemetri (i [Programinsikter](app-insights-overview.md)) representerar `printf` style trace-satser som är text som genomsöks. `Log4Net`, `NLog`, och andra textbaserade loggfilsposter översätts till instanser av den här typen. hello spåra inte mätningar som en utökning.
