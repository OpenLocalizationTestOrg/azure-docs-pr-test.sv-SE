...
3. **Hämta telemetri:** köra projektet i felsökningsläge i några minuter och Sök efter resulterar i bladet översikt i Application Insights.
...
* Den **användare** rapporten räknar antalet unika användare som har åtkomst till dina sidor i din valda tidsperioder. (Användare ska räknas genom att använda cookies. Om någon har åtkomst till din plats med olika webbläsare eller klientdatorer eller rensar sina cookies, och sedan ska räknas mer än en gång.)
...
För att få en förståelse för vad användarna göra med ditt webbprogram, är det praktiskt att infoga rader med kod anpassade händelser. Dessa händelser kan spåra allt från detaljerad användaråtgärder, till exempel att klicka på specifika knapparna till större affärshändelser, till exempel inköp eller vinna spel. 
...
Händelser kan loggas på webbsidan:
...
Eller i serverdelen av webbprogrammet:
