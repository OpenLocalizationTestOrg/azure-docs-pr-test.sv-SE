...
* **Exempel** -en ikon som indikerar att profileraren har hämtats stackspår för den här åtgärden.

Klicka på ikonen exempel öppna trace explorer. Utforskaren innehåller flera exempel att profileraren har hämtats, klassificeras efter svarstid.
