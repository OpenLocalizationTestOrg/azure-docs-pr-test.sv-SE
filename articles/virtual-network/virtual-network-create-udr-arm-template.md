...
> [!IMPORTANT]
> Innan du börjar arbeta med Azure-resurser, är det viktigt toounderstand att Azure har två distributionsmodeller: Azure Resource Manager och klassisk. Se till att du förstår [distributionsmodeller och verktyg](../azure-resource-manager/resource-manager-deployment-model.md) innan du börjar arbeta med Azure-resurser. Du kan visa hello dokumentationen för olika verktyg genom att klicka på flikarna hello hello överst i den här artikeln. Den här artikeln beskriver hello Resource Manager-modellen. 

[!INCLUDE [virtual-network-create-udr-scenario-include.md](../../includes/virtual-network-create-udr-scenario-include.md)]

## <a name="udr-resources-in-a-template-file"></a>UDR resurser i en mallfil
Du kan visa och hämta hello [exempelmall](https://github.com/telmosampaio/azure-templates/tree/master/IaaS-NSG-UDR).

hello följande avsnitt visar hello definition av hello frontend UDR i hello **azuredeploy-vnet-nsg-udr.json** filen hello scenariot:
...
tooassociate hello UDR toohello frontend-undernät du har toochange hello undernätsdefinition i hello mallen och Använd hello referens-id för hello UDR.
...
Du måste också tooensure som hello **FW1** VM har hello IP-vidarebefordring egenskapen är aktiverad på hello NIC som kommer att använda tooreceive och vidarebefordra paket. hello avsnittet nedan visar hello definition av hello NIC för FW1 i hello azuredeploy-nsg-udr.json filen baserat på hello scenariot ovan.
...
hello exempelmall tillgängliga i hello offentliga databasen använder en parameterfil som innehåller hello standard värden som används för toogenerate hello scenario som beskrivs ovan. toodeploy den här mallen med hjälp av klickar du på toodeploy, Följ [länken](https://github.com/telmosampaio/azure-templates/tree/master/IaaS-NSG-UDR), klickar du på **distribuera tooAzure**, ersätta hello Standardparametervärden om det behövs och följ instruktionerna för hello hello-portalen.
...
2. Kör följande kommando toocreate hello en resursgrupp:

    ```powershell
    New-AzureRmResourceGroup -Name TestRG -Location westus
    ```

3. Hello kör följande kommando toodeploy hello mallen:
...
toodeploy hello ARM-mallen med hjälp av hello Azure CLI, fullständig hello följande steg:
...
2. Kör hello efter kommandot tooswitch tooResource Manager läge:
...
3. Från din webbläsare, navigerar för**https://raw.githubusercontent.com/telmosampaio/azure-templates/master/IaaS-NSG-UDR/azuredeploy.parameters.json**, kopiera hello innehållet i hello json-fil och klistra in i en ny fil i din dator. I det här scenariot kan du kopiera hello värden under tooa fil med namnet **c:\udr\azuredeploy.parameters.json**.
...
4. Kör följande kommando toodeploy hello nya VNet med hjälp av hello mallen och parametern filerna du hämtade och ändrade ovan hello:
...
5. Hello kör följande kommando tooview hello resurser som skapas på hello ny resursgrupp:
...
> [!TIP]
> Om du inte ser alla hello resurser kör hello `azure group deployment show` kommandot tooensure hello Etableringsstatus för hello distribution är *lyckad*.
> 
