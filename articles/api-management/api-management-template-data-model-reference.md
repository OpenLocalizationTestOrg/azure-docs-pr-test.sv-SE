...
|Parametrar|Samling av [parametern](#Parameter) entiteter.|Parametrar som definierats för den här åtgärden.|  
...
|Beskrivning|Sträng|Parameterbeskrivning.|  
...
|Egenskap|Typ|Beskrivning|  
|--------------|----------|-----------------|  
|Beskrivning|Sträng|Beskrivning av åtgärden begäran.|  
|Rubriker|matris med [huvud](#Header) entiteter.|Huvuden för begäran.|  
|Parametrar|matris med [Parameter](#Parameter)|De parametrar som begäran igen.|  
...
|Egenskap|Typ|Beskrivning|  
|--------------|----------|-----------------|  
|Sidan|Antal|Det aktuella sidnumret.|  
