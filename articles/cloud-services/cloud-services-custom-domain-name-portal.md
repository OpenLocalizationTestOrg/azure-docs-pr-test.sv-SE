...
> [!NOTE]
> Procedurerna i det här steget gäller för Azure Cloud Services. App-tjänster, se [detta](../app-service-web/web-sites-custom-domain-name.md). Storage-konton finns [detta](../storage/blobs/storage-custom-domain-name.md).
> 
> 
