...
När du skapar en molnbaserad tjänst primärt Azure tooa underdomän cloudapp.net. Till exempel om Molntjänsten har namnet ”contoso”, användarna kommer att kunna tooaccess programmet på en URL som http://contoso.cloudapp.net. Azure ger också en virtuell IP-adress.

Du kan också exponera dina program på ditt eget domännamn, t.ex contoso.com. Den här artikeln förklarar hur tooreserve eller konfigurera ett anpassat domännamn för Molntjänsten web-roller.
...
> [!NOTE]
> Få gå snabbare! Använd hello Azure [guidad genomgång](http://support.microsoft.com/kb/2990804). Gör det associera ett eget domännamn och säker kommunikation (SSL) med Azure Cloud Services eller Azure Websites ett ögonblick.
> 
> 
...
1. Använd någon av dessa metoder toofind hello **. cloudapp.net** domännamn som tilldelats tooyour Molntjänsten.
   ...
   * Inloggningen toohello [klassiska Azure-portalen]väljer Molntjänsten, väljer **instrumentpanelen**, och hitta hello **Webbadress** post i hello **snabböversikten**  avsnitt.
...
1. Använd någon av följande metoder tooget hello IP-adressen för din molntjänst hello.
   ...
   * inloggningen toohello [klassiska Azure-portalen]väljer Molntjänsten, väljer **instrumentpanelen**, och hitta hello **offentliga virtuella IP-adressen** post i hello **snabböversikten** avsnitt.
   ...
   * Installera och konfigurera [Azure Powershell](/powershell/azure/overview), och sedan använda hello följande kommando:
     ...
     Om du har flera slutpunkter som är associerade med din tjänst i molnet, får du flera rader som innehåller hello IP-adress, men alla ska visa hello samma adress.
...
4. Välj eller ange hello domän eller underdomän som ska använda den här A-post. Välj exempelvis **www** om du vill toocreate ett alias för **www.customdomain.com**. Om du vill toocreate en post med jokertecken för alla underdomäner ange '__*__'. Detta kommer att omfatta alla underordnade domäner som **mail.customdomain.com**, **login.customdomain.com**, och **www.customdomain.com**.
...
Det här exemplet visar att skapa en A-post för hello rotdomän. Om du inte vill toocreate ett jokertecken post toocover alla underdomäner anger du ”__*__' som hello underdomänen.
