...
* Följ stegen [här](/azure/app-service-web/app-service-linux-how-to-create-web-app) att skapa en Azure-Webbapp som körs på Linux.
...
Du har konfigurerat en Jenkins pipeline som checkar ut källkoden i GitHub-repo i den här självstudiekursen. Kör Maven för att skapa en war-fil och sedan använder Azure CLI för att distribuera till Azure App Service. Du har lärt dig hur till:
