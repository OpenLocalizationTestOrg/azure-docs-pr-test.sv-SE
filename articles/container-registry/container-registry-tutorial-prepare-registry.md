...
Använd den [az acr inloggning](https://docs.microsoft.com/cli/azure/acr#az_acr_login) kommandot för att autentisera och cachelagrar autentiseringsuppgifter för registret. Ersätt `<acrName>` med namnet på registret som du skapade i föregående steg.
