...
# <a name="task-fail-event"></a>Händelse för aktiviteten misslyckas
 ...
 Denna händelse genereras när en aktivitet har slutförts med ett fel. Alla avslutningskoder som inte är noll är för närvarande anses vara fel. Den här händelsen att orsakat *förutom* en aktivitet slutförts händelse och kan vara används toodetect när en aktivitet misslyckades.


 hello följande exempel visar hello brödtexten i en aktivitet misslyckas händelse.
