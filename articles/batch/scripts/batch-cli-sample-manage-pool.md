...
[!code-azurecli[huvudsakliga](../../../cli_scripts/batch/manage-pool/manage-pool-windows.sh "hantera pooler för Cloud Services")]

## <a name="pool-with-virtual-machine-configuration-sample-script"></a>Pool med exempelskript konfigurationen för virtuell dator

[!code-azurecli[huvudsakliga](../../../cli_scripts/batch/manage-pool/manage-pool-linux.sh "hantera pooler för virtuell dator")]
...
| [Sammanfattning av AZ batch-program](https://docs.microsoft.com/cli/azure/batch/application/summary#list) | Lista över tillgängliga program i Batch-kontot.  |
...
| [Ändra storlek AZ batch-pool](https://docs.microsoft.com/cli/azure/batch/pool#resize) | Ändra storlek på hur många virtuella datorer som körs i den angivna poolen.  |
| [Visa för AZ batch-pool](https://docs.microsoft.com/cli/azure/batch/pool#show) | Visa egenskaperna för en pool.  |
| [ta bort AZ batch-pool](https://docs.microsoft.com/cli/azure/batch/pool#delete) | Ta bort den angivna poolen.  |
...
| [AZ batch nodlistan](https://docs.microsoft.com/cli/azure/batch/node#list) | Lista över alla compute-nod i den angivna poolen.  |
| [omstart av AZ batch nod](https://docs.microsoft.com/cli/azure/batch/node#reboot) | Starta om den angivna compute-nod.  |
| [ta bort AZ batch-nod](https://docs.microsoft.com/cli/azure/batch/node#delete) | Ta bort de angivna noderna från den angivna poolen.  |
