...
---
# <a name="what-happened-toomy-aspnet-project-visual-studio-azure-storage-connected-service"></a>Vad hände toomy ASP.NET-projekt (Visual Studio Azure Storage ansluten service)?
...
Ett element har skapats med hello valt lagringskontots anslutningssträngen och nyckel i hello web.config-filen i projektet.
