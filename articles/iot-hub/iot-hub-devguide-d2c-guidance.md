...
* [Rapporterade egenskaper] [ lnk-twins] för rapportering enhetsinformation tillstånd som tillgängliga funktioner, villkor och tillståndet för tidskrävande arbetsflöden. Konfigurationen och programuppdateringar.
...
| Protokoll | Tillgängligt på alla protokoll. | För närvarande endast tillgängligt när med MQTT. | Tillgängliga när du använder alla protokoll, men kräver HTTP på enheten. |
