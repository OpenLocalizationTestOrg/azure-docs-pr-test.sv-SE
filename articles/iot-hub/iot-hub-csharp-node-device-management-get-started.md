...
5. Lägg till följande fält i klassen **Program**. Ersätt platshållaren värdet med IoT-hubb anslutningssträngen för hubben som du skapade i föregående avsnitt och målenheten.
