...
Använd den **ExportDevicesAsync** metod för att exportera i sin helhet en IoT-hubb identitetsregistret till en [Azure Storage](../storage/index.md) blob-behållare med en [signatur för delad åtkomst](../storage/common/storage-security-guide.md#data-plane-security).
