...
* Node.js version 0.12.x eller senare. Artikeln [förbereda din utvecklingsmiljö] [ lnk-dev-setup] beskriver hur du installerar Node.js för den här självstudiekursen på Windows- eller Linux.
