...
---
# <a name="connect-intel-edison-tooazure-iot-hub-nodejs"></a>Ansluta Intel modern tooAzure IoT-hubb (Node.js)
...
3. Gå sedan följande kommando tooinstall toohello lagringsplatsen mappen toorun hello alla paket kan det ta serval minuter toocomplete.
...
### <a name="configure-and-run-hello-sample-application"></a>Konfigurera och köra hello exempelprogrammet
...
1. Öppna hello config-fil genom att köra följande kommandon hello:
   ...
   Det finns två makron i den här filen kan du configurate. hello först en är `INTERVAL`, som definierar hello tidsintervallet mellan två meddelanden som skickar toocloud. Hej andra `simulatedData`, vilket är ett booleskt värde för om toouse simulerade sensordata eller inte.
