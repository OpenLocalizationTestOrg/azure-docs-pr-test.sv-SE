...
- Kör sedan en exempelkod på din värd datorn tooread hello meddelanden i Azure Table storage. 
...
- [Skapat hello Azure funktionsapp och hello Azure storage-konto](iot-hub-gateway-kit-c-lesson4-deploy-resource-manager-template.md).
- [Kör exempelprogrammet i hello gateway](iot-hub-gateway-kit-c-lesson3-configure-ble-app.md).
