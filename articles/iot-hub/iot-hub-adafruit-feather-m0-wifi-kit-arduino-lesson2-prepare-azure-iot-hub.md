...
---
# <a name="create-your-iot-hub-and-register-your-adafruit-feather-m0-wifi-arduino-board"></a>Skapa din IoT-hubb och registrera Adafruit ludd M0 WiFi Arduino-kort

## <a name="what-you-will-do"></a>Vad du ska göra
* Skapa en resursgrupp.
* Skapa din Azure IoT-hubb i hello resursgruppen.
* Lägga till din Arduino board toohello Azure IoT-hubb med hello Azure-kommandoradsgränssnittet (Azure CLI).

När du använder hello Azure CLI tooadd din IoT-hubb Arduino board tooyour genererar hello tjänsten en nyckel för din Arduino board tooauthenticate med hello-tjänsten. Om du har några problem med söka efter lösningar på hello [felsökning sidan][troubleshoot].

## <a name="what-you-will-learn"></a>Vad får du lära dig
I den här artikeln får du lära dig:
* Hur toouse hello Azure CLI toocreate en IoT-hubb.
* Hur board toocreate en enhetsidentitet för din Arduino i din IoT-hubb.

## <a name="what-you-need"></a>Vad du behöver
* Ett Azure-konto
* En dator med hello Azure CLI är installerat
...
## <a name="register-your-arduino-board-in-your-iot-hub"></a>Registrera din Arduino för ändringar i din IoT-hubb
...
Registrera din Arduino för ändringar i din IoT-hubb genom att köra följande kommando:
...
Du har skapat en IoT-hubb och registrerad Arduino-kort med en enhetsidentitet i din IoT-hubb. Du är klar toolearn hur toosend meddelanden från din Arduino board tooyour IoT-hubb.
