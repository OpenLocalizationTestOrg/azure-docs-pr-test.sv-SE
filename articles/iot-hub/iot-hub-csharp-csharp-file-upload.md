...
Dessa filer finns vanligtvis i molnet med hjälp av verktyg som bearbetas i batch [Azure Data Factory](../data-factory/index.md) eller [Hadoop](../hdinsight/index.md) stacken. När du behöver överföra filer från en enhet kan du fortfarande använda säkerheten och pålitligheten för IoT-hubb.
