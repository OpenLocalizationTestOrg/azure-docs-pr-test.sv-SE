...
Den [Microsoft Azure-portalen](https://portal.azure.com) är en central plats där du kan etablera och hantera Azure-resurser. Den organiserar dess innehåll med hjälp av _blad_. I vissa självstudier för IoT-hubb kan du bli ombedd att använda den [klassiska Azure-portalen](https://manage.windowsazure.com).
