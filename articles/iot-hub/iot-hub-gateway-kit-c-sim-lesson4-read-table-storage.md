...
- Köra exempelkod på värddatorn för att läsa meddelanden i Azure Table storage.
...
- [Skapade appen Azure-funktion och Azure-lagringskontot](iot-hub-gateway-kit-c-sim-lesson4-deploy-resource-manager-template.md).
- [Kör exempelprogrammet gateway](iot-hub-gateway-kit-c-sim-lesson3-configure-simulated-device-app.md).
