...
1. Kontrollera att du arbetar i hello lagringsplatsen mappen `iot-hub-node-edison-getting-started`. Öppna hello exempelprogrammet i Visual Studio Code genom att köra följande kommandon hello:
