...
> [!IMPORTANT]
> JSON-matris parsning funktioner är för närvarande under förhandsgranskning. Det är bara tillgängliga i REST-API som använder version **2015-02-28-Preview**. Kom ihåg, förhandsgranska API: er är avsedd för testning och utvärdering och ska inte användas i produktionsmiljöer.
>
>
