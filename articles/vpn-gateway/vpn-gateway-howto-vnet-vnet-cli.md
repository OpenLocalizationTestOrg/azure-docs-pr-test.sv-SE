...
### <a name="samerg"></a>För att ansluta Vnets som finns i samma resursgrupp
...
### <a name="verifyranges"></a>Steg 6 – Kontrollera IP-adressintervaller
