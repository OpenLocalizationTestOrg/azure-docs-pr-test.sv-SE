...
# Kom igång
## [Distribuera en skala som angetts i hello-portalen](virtual-machine-scale-sets-portal-create.md)
...
## Distribuera
### [Skapa med hello-portalen](virtual-machine-scale-sets-portal-create.md)
...
### [Konvertera en scale set mallen toouse hanterade disk](virtual-machine-scale-sets-convert-template-to-md.md)
...
### [Konvertera en mall toomanaged diskar](virtual-machine-scale-sets-convert-template-to-md.md)
