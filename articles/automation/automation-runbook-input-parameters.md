...
När du [starta runbook](automation-starting-a-runbook.md#starting-a-runbook-with-the-azure-portal), **starta Runbook** blad öppnas och du kan konfigurera värden för parametrarna som du nyss skapade.
