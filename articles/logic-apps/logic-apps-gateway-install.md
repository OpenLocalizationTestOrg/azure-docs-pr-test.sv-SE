...
Gatewayen körs som en Windows-tjänst. Precis som alla andra Windows-tjänster, kan du starta och stoppa tjänsten på flera olika sätt. Du kan till exempel öppna en kommandotolk med förhöjd behörighet på den dator där gatewayen körs och kör antingen dessa kommandon:
...
Lokala datagateway har konfigurerats att använda `NT SERVICE\PBIEgwService` tjänsten inloggningsuppgifter för Windows. Gatewayen har som standard rättigheten ”logga in som en tjänst” på datorn där du installerar en gateway.
