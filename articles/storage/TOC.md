...
### [Koppla en virtuell Windows-dator för hanterade diskar tooa med hjälp av PowerShell](../virtual-machines/windows/attach-disk-ps.md)
...
### [Anonym åtkomst tooblobs](storage-manage-access-to-resources.md)
...
### [Migrera virtuella datorer i Azure tooAzure hanterade diskar](../virtual-machines/windows/migrate-to-managed-disks.md)
### [Migrera från AWS och andra plattformar tooManaged diskar](../virtual-machines/windows/on-prem-to-azure.md)
...
#### [Migrera tooPremium lagring med hjälp av Azure Site Recovery](storage-migrate-to-premium-storage-using-azure-site-recovery.md)
...
#### [Migrera tooPremium lagring](storage-migration-to-premium-storage.md)
...
### [Använd hello Storage-emulatorn](storage-use-emulator.md)
...
## Överföra data
### [Flytta data tooand från lagret](storage-moving-data.md)
### [AzCopy i Windows](storage-use-azcopy.md)
### [AzCopy i Linux](storage-use-azcopy-linux.md)
### [Med hjälp av hello Import/Export service](storage-import-export-service.md)
### [Med hjälp av hello verktyget Import/Export](storage-import-export-tool-how-to.md)
#### [Konfigurera hello verktyget Import/Export](storage-import-export-tool-setup.md)
...
#### [Felsöka hello verktyget Import/Export](storage-import-export-tool-troubleshooting-v1.md)
...
### [Med hjälp av hello Import/Export-verktyget (v1)](storage-import-export-tool-how-to-v1.md)
#### [Konfigurera hello verktyget Import/Export](storage-import-export-tool-setup-v1.md)
...
#### [Import/Export-tjänstens metadata och egenskapers filformat](storage-import-export-file-format-metadata-and-properties.md)
#### [Loggfilformat för Import/Export-tjänsten](storage-import-export-file-format-log.md)
### [Med hjälp av hello Azure Import/Export service REST API](storage-import-export-using-the-rest-api.md)
