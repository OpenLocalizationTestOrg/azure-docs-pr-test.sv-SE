...
## <a name="prepare-the-disks-when-data-already-copied-to-the-disks"></a>Förbereda diskarna när data som redan har kopierat till diskar
 Här är ett Exempelkommando för att förbereda en diskar när data som redan har kopierat till hårddisken som inte har ännu tagits krypteras med BitLocker:  
...
## <a name="copy-a-single-directory-to-a-hard-drive"></a>Kopiera en katalog på en hårddisk  
 Här är en Exempelkommando för att kopiera en enda källkatalog till en hårddisk som inte har ännu tagits krypteras med BitLocker:  
  
```  
WAImportExport.exe PrepImport /j:FirstDrive.jrn /id:movies /logdir:c:\logs /sk:8ImTigJhIwvL9VEIQKB/zbqcXbxrIHbBjLIfOt0tyR98TxtFvUM/7T0KVNR6KRkJrh26u5I8hTxTLM2O1aDVqg== /t:x /format /encrypt /srcdir:d:\Movies /dstdir:entertainment/movies/  
```  
  
## <a name="copy-wwo-directories-to-a-hard-drive"></a>Kopiera wwo kataloger till en hårddisk  
 Om du vill kopiera två kataloger för källan till en enhet måste två kommandon.  
  
 Det första kommandot anger loggkatalogen, lagringskontonyckel, mål enhetsbeteckning och `format/encrypt` krav, förutom de vanliga parametrarna:  
...
## <a name="copy-a-large-file-to-a-hard-drive-in-a-second-copy-session"></a>Kopiera en stor fil till en hårddisk i en andra kopia-session  
 Här är ett Exempelkommando som kopierar en enda stor fil till en enhet som har förberetts i en tidigare session kopia:  
