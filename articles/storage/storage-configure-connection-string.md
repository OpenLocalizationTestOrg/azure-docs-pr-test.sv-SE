...
Ett scenario där du kanske vill toospecify en explicit slutpunkt är när du har kopplat till ditt Blob storage endpoint tooa [domänen](storage-custom-domain-name.md). I så fall kan du ange din anpassade slutpunkt för Blob storage i anslutningssträngen. Du kan också ange hello standardslutpunkterna för hello andra tjänster om programmet använder dem.
