...
Ett scenario där du kanske vill ange en explicit slutpunkt är när du har anslutit din slutpunkt för Blob-lagring till en [domänen](storage-custom-domain-name.md). I så fall kan du ange din anpassade slutpunkt för Blob storage i anslutningssträngen. Du kan också ange standardslutpunkterna för andra tjänster om programmet använder dem.
