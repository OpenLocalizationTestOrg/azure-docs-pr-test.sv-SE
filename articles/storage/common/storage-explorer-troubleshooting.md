...
Microsoft Azure Lagringsutforskaren (förhandsversion) är en fristående app som gör det enkelt att arbeta med Azure Storage-data i Windows, macOS och Linux. Appen kan ansluta toStorage konton finns i Azure, statliga moln och Azure-stacken.
...
Innan du fortsätter försök att starta om programmet och se om problemen kan åtgärdas.
...
- Kontrollera att ditt konto har åtkomst till prenumerationerna genom att logga in på Azure Portal.
