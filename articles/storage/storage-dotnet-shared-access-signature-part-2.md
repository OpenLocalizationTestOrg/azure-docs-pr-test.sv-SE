...
[Del 1](storage-dotnet-shared-access-signature-part-1.md) i den här kursen utforskade signaturer för delad åtkomst (SAS) och beskrivs bästa praxis för att använda dem. Del 2 visar hur du skapar och sedan använda signaturer för delad åtkomst med Blob storage. Exemplen är skrivna i C# och använder Azure Storage-klientbiblioteket för .NET. Exemplen i den här kursen:
...
* [Signaturer för delad åtkomst, del 1: Förstå SAS-modellen](storage-dotnet-shared-access-signature-part-1.md)
