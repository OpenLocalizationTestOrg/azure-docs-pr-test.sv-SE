...
[Del 1](storage-dotnet-shared-access-signature-part-1.md) i den här kursen utforskade signaturer för delad åtkomst (SAS) och beskrivs bästa praxis för att använda dem. Del 2 visar hur toogenerate och sedan använda delad åtkomst signaturer med Blob storage. hello exemplen är skrivna i C# och använder hello Azure Storage-klientbibliotek för .NET. hello exemplen i den här kursen:
...
* [Signaturer för delad åtkomst, del 1: Förstå hello SAS-modellen](storage-dotnet-shared-access-signature-part-1.md)
