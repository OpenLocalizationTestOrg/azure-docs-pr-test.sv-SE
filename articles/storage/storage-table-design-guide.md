...
Som standard hello tabelltjänsten implementerar Optimistisk samtidighet kontrollerar på hello nivå för enskilda entiteter för **infoga**, **sammanfoga**, och **ta bort** åtgärder, även om det är möjligt för en klient tooforce hello tabell service toobypass kontrollerna. Mer information om hur hello tabelltjänsten hanterar samtidighet finns [hantera samtidighet i Microsoft Azure Storage](storage-concurrency.md).  
...
Läs mer om hur du använder SAS-token med hello tabelltjänsten [med delad åtkomst signaturer (SAS)](storage-dotnet-shared-access-signature-part-1.md).  
