...
I den här artikeln ska vi pratar om olika användningsområden för diskar och beskrivs de olika typerna av diskar som du kan skapa och använda. Den här artikeln är också tillgängligt för [virtuella Linux-datorer](storage-about-disks-and-vhds-linux.md).
...
* [Ansluta en disk](../virtual-machines/windows/attach-managed-disk-portal.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json) att lägga till ytterligare lagringsutrymme för den virtuella datorn.
* [Ändra enhetsbeteckningen för den tillfälliga disken i Windows](../virtual-machines/windows/change-drive-letter.md?toc=%2fazure%2fvirtual-machines%2fwindows%2fclassic%2ftoc.json) så att programmet kan använda enheten D: för data.
