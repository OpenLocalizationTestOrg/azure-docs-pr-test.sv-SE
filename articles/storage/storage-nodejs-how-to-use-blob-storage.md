...
Instruktioner om hur du skapar en Node.js-program finns i [skapa en Node.js-webbapp i Azure App Service], [skapa och distribuera ett Node.js-program till en Azure-molntjänst] --med Windows PowerShell eller [skapa och distribuera en Node.js-webbapp till Azure med hjälp av Web Matrix].
...
Ett exempel på Ange miljövariabler i den [Azure-portalen](https://portal.azure.com) för en Azure webbapp, se [Node.js-webbapp som använder tjänsten Azure Table].
...
* [Azure Storage SDK för noden API-referens][Azure Storage SDK for Node API Reference]
...
[Node.js-webbapp som använder tjänsten Azure Table]: ../app-service-web/storage-nodejs-use-table-storage-web-site.md
[skapa och distribuera en Node.js-webbapp till Azure med hjälp av Web Matrix]: ../app-service-web/web-sites-nodejs-use-webmatrix.md
