...
Anvisningar för hur toocreate ett Node.js-program finns [skapa en Node.js-webbapp i Azure App Service], [skapa och distribuera en Node.js-programmet tooan Azure Cloud Service] --med Windows PowerShell , eller [skapa och distribuera en Node.js web app tooAzure med hjälp av Web Matrix].
...
Ett exempel på inställningen hello miljövariabler i hello [Azure-portalen](https://portal.azure.com) för en Azure webbapp, se [Node.js web app med hello Azure Tabelltjänsten].
