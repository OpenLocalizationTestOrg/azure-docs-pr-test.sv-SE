...
* Visa mer funktionen guider toolearn om ytterligare alternativ för att lagra data i Azure.
  * [Komma igång med Azure Table storage med hjälp av .NET](storage-dotnet-how-to-use-tables.md) toostore strukturerade data.
  * [Komma igång med Azure Blob storage med hjälp av .NET](storage-dotnet-how-to-use-blobs.md) toostore Ostrukturerade data.
