...
* [Använda hanterade diskar i Azure Resource Manager-mallar](storage-using-managed-disks-template-deployments.md)

### <a name="compare-managed-disks-storage-options"></a>Jämför lagringsalternativ för hanterade diskar

* [Premium-lagring och diskar](storage-premium-storage.md)

* [Standardlagring och diskar](storage-standard-storage.md)
