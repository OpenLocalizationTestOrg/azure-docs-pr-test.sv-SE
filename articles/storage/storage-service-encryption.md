...
Azure File storage erbjuder filresurser i molnet genom att använda SMB-standardprotokollet. Du kan montera en filresurs från en klient lokalt eller i Azure. När monterad, användas verktyg, exempelvis Robocopy för att kopiera filer över till Azure-filresurser. Mer information finns i [för Azure-filresurs på Windows](storage-file-how-to-use-files-windows.md) och [för Azure-filresurs på Linux](storage-how-to-use-files-linux.md).
...
Om du vill veta mer kan du besöka vårt [komma igång med Azure Blob storage med hjälp av .NET](storage-dotnet-how-to-use-blobs.md).
