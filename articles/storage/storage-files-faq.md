...
* **FRÅGOR. När bör jag använda Azure File vs Azure Blob vs Azure-disken?**  
    ...
    Läs mer på [ska när toouse Azure BLOB-objekt, Azure-filer eller Azure Datadiskar](storage-decide-blobs-files-disks.md)
...
* **FRÅGOR. Hur kommer jag igång med Azure File storage?**  
    ...
    * [Lär dig hur toocreate Azure File dela med hello Portal](storage-file-how-to-create-file-share.md#create-file-share-through-the-portal)
    * [Lär dig hur toocreate Azure File dela med hjälp av Powershell](storage-file-how-to-create-file-share.md#create-file-share-through-powershell)
    * [Lär dig hur toocreate Azure File dela med hjälp av CLI](storage-file-how-to-create-file-share.md#create-file-share-through-command-line-interface-cli)
...
* **FRÅGOR. Hur felsöker Azure File storage fel?**
    ...
    Du kan se för[Azure File storage felsökning artikel](storage-troubleshoot-file-connection-problems.md) för slutpunkt till slutpunkt felsökningsinformation. 
...
* [Använda hello Azure CLI med Azure Storage](storage-azure-cli.md)
