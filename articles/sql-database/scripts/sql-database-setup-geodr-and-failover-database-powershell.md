...
[!code-powershell[huvudsakliga](../../../powershell_scripts/sql-database/setup-geodr-and-failover-database/setup-geodr-and-failover-database.ps1?highlight=17-20 "konfigurera aktiv geo-replikering för en enskild databas")]
