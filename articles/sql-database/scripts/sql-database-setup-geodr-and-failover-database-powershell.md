...
---
# <a name="use-powershell-tooconfigure-active-geo-replication-for-a-single-azure-sql-database"></a>Använd PowerShell tooconfigure aktiv geo-replikering för en enskild Azure SQL-databas

Det här exemplet för PowerShell-skriptet konfigurerar aktiv geo-replikering för en enda Azure SQL-databas och växlar tooa sekundär replik av hello Azure SQL-databas.
