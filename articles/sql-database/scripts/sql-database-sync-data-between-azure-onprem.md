...
---
# <a name="use-powershell-toosync-between-an-azure-sql-database-and-a-sql-server-on-premises-database"></a>Använd PowerShell toosync mellan en Azure SQL Database och en lokal SQL Server-databas

Det här exemplet PowerShell konfigurerar datasynkronisering toosync mellan en Azure SQL Database och en lokal SQL Server-databas. 
