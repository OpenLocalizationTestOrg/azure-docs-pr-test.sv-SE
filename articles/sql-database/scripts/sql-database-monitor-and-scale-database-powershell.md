...
[!code-powershell[huvudsakliga](../../../powershell_scripts/sql-database/monitor-and-scale-database/monitor-and-scale-database.ps1?highlight=13-14 "Övervakare och skala en SQL-databas")]
