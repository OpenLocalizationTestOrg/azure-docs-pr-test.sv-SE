...
- [**Fråga hello status för en paketinsamling**](#query-packet-capture-status)
...
I det här scenariot kan du anropa hello nätverket Watcher Rest API toorun IP flöda kontrollera. ARMclient är används toocall hello REST-API med hjälp av PowerShell. ARMClient hittas på chocolatey på [ARMClient på Chocolatey](https://chocolatey.org/packages/ARMClient)
...
Kör följande skript tooreturn hello en virtuell dator. Den här informationen behövs för att starta en paketinsamling.

hello måste följande kod variabler:
...
Från hello följande utdata, används hello-id för hello virtuell dator i hello nästa exempel.
...
hello hämtar följande exempel hello status för en enskild paketinsamling
...
hello är följande svar exempel på en typisk svaret som returnerades vid fråga hello status för en paketinsamling.
...
hello följande exempel hämtar alla paket avbilda sessioner i en region.
...
hello följande svaret är ett exempel på ett typiskt svar returneras när du hämtar alla paket avbildas
...
hello är följande svaret ett exempel på ett typiskt svar som returnerades vid fråga hello status för en paketinsamling.
...
hello följande exempel skapar en paketinsamling på en virtuell dator.  hello exempel är parametriserade tooallow flexibilitet att skapa ett exempel.
...
hello följande exempel stoppar en paketinsamling på en virtuell dator.  hello exempel är parametriserade tooallow flexibilitet att skapa ett exempel.
...
hello följande exempel tar bort en paketinsamling på en virtuell dator.  hello exempel är parametriserade tooallow flexibilitet att skapa ett exempel.
...
> [!NOTE]
> Om du tar bort en paketinsamling tas filen inte bort hello i hello storage-konto
