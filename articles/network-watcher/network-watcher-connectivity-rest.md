...
Kontrollera anslutningen är för närvarande i förhandsversion, toouse funktionen toobe registrerade måste. toodo detta, kör hello följande PowerShell-exempel:
...
tooverify hello registreringen har slutförts, kör följande Powershell-exempel hello:
...
Kör följande skript tooreturn hello en virtuell dator. Den här informationen behövs för att köra anslutningen. 
...
Eftersom den här åtgärden är långt returneras kör hello URI för hello resultat i hello svarshuvud enligt hello efter svar:
...
hello är följande exempel hello svar från kör hello tidigare API-anrop. Eftersom hello kontrollera lyckade hello `connectionStatus` egenskapen visas som **nåbar**.  Hello information om hello antal hopp krävs tooreach hello storage-blob och svarstid finns.
