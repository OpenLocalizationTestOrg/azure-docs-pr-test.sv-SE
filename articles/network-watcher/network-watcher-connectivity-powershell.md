...
Anslutningen är för närvarande i förhandsversion, toouse funktionen måste toobe registrerad. toodo detta, kör hello följande PowerShell-exempel:
...
följande exempel hello testar hello anslutning från ett lagringskonto för virtuell dator tooa blogg.
...
hello är följande json hello exempelsvar körs hello föregående cmdlet. Eftersom hello målet kan nås, hello `ConnectionStatus` egenskapen visas som **nåbar**.  Hello information om hello antal hopp krävs tooreach hello storage-blob och svarstid finns.
