...
Event debiteras Hubs varje timme, baserat på det maximala antalet enheter som är markerade under den angivna timmen.
...
Avbilda aktiveras när alla händelsehubb i namnområdet har aktiverat alternativet avbildning. Event Hubs avbilda faktureras timvis per köpta Genomflödesenhet. Eftersom antalet Genomflödesenhet ökas eller minskas, visar Event Hubs avbilda fakturering ändringarna i steg om hela timme. Mer information om händelsen hubbar avbilda fakturering finns [Händelsehubbar prisinformation](https://azure.microsoft.com/pricing/details/event-hubs/).
