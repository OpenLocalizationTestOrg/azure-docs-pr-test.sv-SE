...
> [!NOTE]
> Stream Analytics stöder inte att lägga till innehåll till en befintlig blob. Stream Analytics Visa bara en gång en blob och alla ändringar som görs i blob när jobbet har läsa data bearbetas inte. Ett bra tips är att överföra alla data en gång och sedan inte lägga till händelser som blobstore.
> 
