...
## <a name="find-operation-logs-in-the-azure-management-portal"></a>Hitta åtgärden loggas i Azure-hanteringsportalen
...
En länk till en Stream Analytics-jobbet motsvarande loggarna visas på fliken instrumentpanelen i jobbets. Om du klickar på länken anges filtren så att den visar senaste loggar för det specifika jobbet.
...
1. Klicka på **hanteringstjänster** i den [Azure klassiska portal](https://manage.windowsazure.com).
...
Då öppnas ett blad som visar händelser från de senaste 7 dagarna för alla resurser i din prenumeration.  Du kan filtrera om du vill se händelser med en ange typ eller tidsintervall genom att klicka på den **Filter** kommando.
...
I Azure-hanteringsportalen klickar du på den **information** längst ned i fönstret för att visa mer information om en markerad händelse. 
...
Därifrån kan du öppna den **detaljer** bladet genom att klicka på händelsen.
...
Klicka på sökikonen och typ ”misslyckad” i Azure-hanteringsportalen. Detta ger ett resultat av alla loggar med fel. 
