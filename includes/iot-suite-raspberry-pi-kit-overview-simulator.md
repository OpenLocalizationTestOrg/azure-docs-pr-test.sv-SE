...
- Konfigurera din enhet toocommunicate med datorn och hello remote övervakningslösning.
- Uppdatera hello exempel enhet kod tooconnect toohello remote övervakningslösning och skicka simulerade telemetri som kan visas på instrumentpanelen för hello-lösning.
...
En stationär dator tooenable du tooconnect via fjärranslutning toohello kommandot rad på hello hallon Pi.

[Microsoft IoT startpaket för hallon Pi 3] [ lnk-starter-kits] eller motsvarande komponenter. Den här kursen använder följande objekt från hello kit hello:
