...
toowatch en video som visar hur toomount, initiera och formatera StorSimple-volym klickar du på [här](https://azure.microsoft.com/documentation/videos/mount-initialize-and-format-a-storsimple-volume/).
