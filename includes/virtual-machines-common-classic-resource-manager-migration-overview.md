...
| Nätverk |Virtuellt nätverk med både ExpressRoute-Gateway och VPN-Gateway  | Ta bort VPN-Gateway innan du påbörjar migreringen och sedan återskapa VPN-gatewayen när migreringen är klar. Lär dig mer om [ExpressRoute migrering](../articles/expressroute/expressroute-migration-classic-resource-manager.md).|
| Nätverk |ExpressRoute med auktorisering länkar  | Ta bort ExpressRoute-kretsen till virtaul nätverksanslutningen innan du påbörjar migreringen och sedan återskapa anslutningen när migreringen är klar. Lär dig mer om [ExpressRoute migrering](../articles/expressroute/expressroute-migration-classic-resource-manager.md). |
...
| Compute |Tillägg för Azure Security Center med ett virtuellt nätverk som har en VPN-gateway i överföringen anslutningen eller ExpressRoute-gateway med lokala DNS-server |Azure Security Center installeras automatiskt tillägg på dina virtuella datorer för att övervaka deras säkerhet och generera aviseringar. Dessa tillägg installeras vanligtvis automatiskt om Azure Security Center-principen är aktiverad för prenumerationen. ExpressRoute-gateway migrering stöds inte för närvarande och VPN-gatewayer med överföring anslutningen förlorar lokal åtkomst. Ta bort ExpressRoute gör gateway eller migrera VPN-gateway med överföring anslutningen att internet-åtkomst till VM storage-konto går förlorade när fortsätter med utför migreringen. Migreringen kommer inte att fortsätta när detta inträffar eftersom statusblobben för gäst-agenten inte kan fyllas i. Det rekommenderas att inaktivera Azure Security Center-princip på prenumerationen 3 timmar innan du fortsätter med migreringen. |
