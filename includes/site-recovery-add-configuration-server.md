...
5. I **Internet Settings** (Internetinställningar) anger du hur providern som körs på konfigurationsservern ska ansluta till Azure Site Recovery via internet.
   ...
   a. Om du vill ansluta till proxyservern som för närvarande har ställts in på datorn, väljer **Anslut till Azure Site Recovery via en proxyserver**.

   b. Om du vill att providern ska ansluta direkt väljer **Anslut direkt till Azure Site Recovery utan en proxyserver**.

   c. Om den befintliga proxyservern kräver autentisering, eller om du vill använda en anpassad proxyserver för provideranslutningen, väljer du **Anslut med anpassade proxyinställningar**.

     * Om du använder en anpassad proxyserver måste du ange adressen, porten och autentiseringsuppgifterna.
     * Om du använder en proxyserver du bör redan ha tillåtit URL: er som beskrivs i [krav](#prerequisites).
