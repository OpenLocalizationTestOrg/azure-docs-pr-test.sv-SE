...
I den här artikeln får körde du en enkel IoT gräns-gatewayen som skriver meddelanden till en loggfil. Om du vill köra ett exempel som skickar meddelanden till IoT-hubb finns [IoT kant – skicka meddelanden från enhet till moln med en simulerad enhet med hjälp av Linux] [ lnk-gateway-simulated-linux] eller [IoT kant – skicka meddelanden från enhet till moln med en simulerade enhet med hjälp av Windows][lnk-gateway-simulated-windows].
