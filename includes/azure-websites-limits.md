...
| [Skalbar](../articles/app-service-web/web-sites-scale.md) (max instanser) |1 delad |1 delad |3 dedikerade<sup>3</sup> |10 dedikerade<sup>3</sup> |20 dedikerad (50 i ASE)<sup>3,4</sup> |
...
| Samtidiga [felsökningsprogrammet anslutningar](../articles/app-service-web/web-sites-dotnet-troubleshoot-visual-studio.md) per program |1 |1 |1 |5 |5 |
| [azurewebsites.NET underdomänen med FTP-/ S och SSL](../articles/app-service-web/web-sites-configure-ssl-certificate.md) |X |X |X |X |X |
| [Anpassad domän](../articles/app-service-web/web-sites-custom-domain-name.md) stöd | |X |X |X |X |
| Anpassad domän [SSL-stöd](../articles/app-service-web/web-sites-configure-ssl-certificate.md) | | |Obegränsat |Obegränsad, 5 SNI SSL och 1 IP SSL-anslutningar som ingår |Obegränsad, 5 SNI SSL och 1 IP SSL-anslutningar som ingår |
| Integrerad belastningsutjämnare | |X |X |X |X |
| [Always On](../articles/app-service-web/web-sites-configure.md) | | |X |X |X |
| [Schemalagda säkerhetskopieringar](../articles/app-service-web/web-sites-backup.md) | | | |En gång per dag |Var 5: e minut<sup>8</sup> |
| [Automatisk skalning](../articles/app-service-web/web-sites-scale.md) | | |X |X |X |
| [WebJobs](../articles/app-service-web/web-sites-create-web-jobs.md)<sup>9</sup> |X |X |X |X |X |
| [Azure Scheduler](https://azure.microsoft.com/services/scheduler/) stöd | |X |X |X |X |
| [Slutpunktsövervakning](../articles/app-service-web/web-sites-monitor.md) | | |X |X |X |
| [Mellanlagringsplatser](../articles/app-service-web/web-sites-staged-publishing.md) | | | |5 |20 |
