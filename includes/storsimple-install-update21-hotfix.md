...
3. Ange hello Knowledge Base (KB) nummer i sökrutan för hello Microsoft Update-katalogen hello hello snabbkorrigering som du vill toodownload, till exempel **3179904**, och klicka sedan på **Sök**.
   
    hello snabbkorrigeringen visas, till exempel **kumulativa programvara paket Update 2.2 för StorSimple 8000-serien**.
...
5. Sök efter eventuella ytterligare snabbkorrigeringar som anges i hello tabellen ovan (**3103616**, **3146621**), och Lägg till varje toohello korg.
...
4. Typen **Y** när begärd tooconfirm hello snabbkorrigeringsinstallationen.
   ...
   > [!IMPORTANT]
   > Om du installerar uppdateringen 2.2 bara installera hello-binärfilen som inleds med ”alla hcsmdssoftwareudpate'. Installera inte hello Cis och hello MDS agentuppdatering inleds med alla cismdsagentupdatebundle. Fel toodo så resulterar i ett fel. 
...
1. Kontrollera hello system programvaruversioner när hello programuppdateringen har slutförts. Ange:
   ...
   * `MdsAgentVersion: 30.0.4698.16` 
     ...
     > 
     > 
2. Upprepa steg 3-5 tooinstall hello återstående snabbkorrigeringar regular-läge.
   
   * hello iSCSI uppdateringen KB3146621
   * hello WMI uppdateringen KB3103616
3. Hoppa över det här steget om du uppdaterar från uppdatering 2. Om du uppdaterar från en tidigare version tooUpdate 2, måste du också toodownload:

    - hello LSI drivrutinen KB3121900

    - Hej Spaceport uppdatering KB3090322

    - hello Storport uppdateringen KB3080728
