...
| Belastningsutjämnare (interna och mot internet) |100 |kontakta supporten |
| Belastningsutjämningsreglerna per belastningsutjämnare |150 |150 |
| Belastningsutjämningsreglerna per IP-konfiguration |299 |299 |
| Klientdelen för offentlig IP per belastningsutjämnare |10 |30 |
| Klientdelen privata IP-adress per belastningsutjämnare |10 |kontakta supporten |
